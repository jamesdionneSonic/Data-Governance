...
const AUTH_MODE_HELP = Object.freeze({
  ...
  azure_cli: 'Use the local Azure CLI login. No token or password is stored in the connector.',
  ...
  azure_data_factory: {
    ...
    basic_fields: [
      ...
      },
      {
        ...
        input: 'text',
        required: true,
        placeholder: 'rg-data-warehouse-prod',
        config_key: 'resource_group',
      },
      {
        key: 'factory_name',
        label: 'Factory name',
        input: 'text',
        required: true,
        placeholder: 'adf-dw-marketing-prod',
    ...
    advanced_fields: [
      ...
      {
        key: 'azure_cli_timeout_ms',
        label: 'Azure CLI timeout (ms)',
        input: 'number',
        placeholder: '30000',
        config_key: 'azure_cli_timeout_ms',
      },
      {
        key: 'run_history_lookback_days',
        label: 'Run history lookback days',
        input: 'number',
        placeholder: '30',
        config_key: 'run_history_lookback_days',
      },
      {
        key: 'activity_run_pipeline_limit',
        label: 'Activity run pipeline limit',
        input: 'number',
        placeholder: '50',
        config_key: 'activity_run_pipeline_limit',
      },
    ],
  },
  power_bi: {
...
export const CONNECTOR_TYPES = Object.freeze({
  ...
  AZURE_DATA_FACTORY: {
    ...
    credentialKinds: ['azure_cli', 'managed_identity', 'service_principal', 'delegated_oauth'],
  },
  SSIS: {
    type: 'ssis',
