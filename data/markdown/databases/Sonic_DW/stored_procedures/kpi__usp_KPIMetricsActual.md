...
CREATE PROCEDURE [kpi].[usp_KPIMetricsActual]
	 @FactKPIActualKey INT
	,@KPIMetricKey INT
	,@EntityKey INT
	,@DateKey INT
...
/* =========================================================================================
    ...
    Description:	Insert/Update records for Fact_KPIMetricActual_TXN - manual metrics
...
BEGIN TRY
	...
	IF (SELECT FactKPIActualKey from [kpi].[Fact_KPIMetricActual_TXN] where EntityKey = @EntityKey and KPIMetricKey=@KPIMetricKey and DateKey = @DateKey) IS NULL

		BEGIN

			INSERT INTO [kpi].[Fact_KPIMetricActual_TXN]
			SELECT   @KPIMetricKey
					,@EntityKey
					,@DateKey
					,@MetricValue
	...
	---------------------------------------------------------------------------------------------------------------------------------
		...
		BEGIN
			...
			UPDATE [kpi].[Fact_KPIMetricActual_TXN]
