---
name: usp_Fuel2_Insert_Dim_GLSchedule_degen_03242017
database: Sonic_DW
type: procedure
schema: dbo
owner: Data Team
...
*************************************************************************/
CREATE PROCEDURE [dbo].[usp_Fuel2_Insert_Dim_GLSchedule_degen_03242017]
...
BEGIN
	SET NOCOUNT ON;
		...
		------------------------------------------------------------------------------------------
			...
			MERGE dbo.dim_GLSchedule_degen_03242017 AS T		/*	added the schema to the table name.	*/
