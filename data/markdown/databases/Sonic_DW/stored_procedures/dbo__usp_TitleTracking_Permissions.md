...
| ----------------------------- | ------- | ------ | ------- |
| `@UserEntityKey`              | int     | No     | No      |
| `@EmployeeID`                 | int     | No     | No      |
| `@EntityKey`                  | int     | No     | No      |
| `@UE_isActive`                | bit     | No     | No      |
| `@UE_IsDefault`               | bit     | No     | No      |
| `@UE_IsGM`                    | bit     | No     | No      |
| `@UE_IsController`            | bit     | No     | No      |
| `@UE_DOCPermission`           | int     | No     | No      |
| `@Meta_LastChangeUserName`    | varchar | No     | No      |
| `@UE_TitleTrackingPermission` | int     | No     | No      |
