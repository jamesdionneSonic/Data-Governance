...
-- ============================================================================================================================================================================================================
*/
CREATE PROCEDURE [dbo].[usp_GLBalancesLoad]
AS

BEGIN
       SET NOCOUNT ON;

       declare @BalanceForDate datetime = '2012-01-01'
       ...
       while @BalanceForDate <= @MaxRunDate
              begin
                    ...
                    --------------------------------------------------------------------------------------------------------------
                     ...
                     insert into Sonic_DW.dbo.Fact_GLBalances (EntityKey,AccountKey,MonthBeginDateKey,BalanceForDateKey,YTD,PostingAmount,BalAsOf,[User_ID],                                                                     Meta_Src_Sys_ID,Meta_ComputerName,Meta_LoadDate)
                     select
