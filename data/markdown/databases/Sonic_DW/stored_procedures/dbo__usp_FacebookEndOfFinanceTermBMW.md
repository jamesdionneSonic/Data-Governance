...
*/
CREATE     PROCEDURE [dbo].[usp_FacebookEndOfFinanceTermBMW] @EOFMonth INT
	,@EOFRange INT
AS
BEGIN
	...
	SELECT @AudienceType = CASE @EOFMonth
			WHEN 24
				THEN 'FBAudienceEndofFinanceBMW'
			WHEN 12
				THEN 'FBAudienceEndofFinanceBMW'
			...
			WHEN 6
				THEN 'FBAudienceEndofFinanceBMW'
			WHEN 3
				THEN 'FBAudienceEndofFinanceBMW3months'
			WHEN 2
				THEN 'FBAudienceEndofFinanceBMW2months'
			WHEN 1
				THEN 'FBAudienceEndofFinanceBMW1months'
			END
