---
name: usp_FBCustomAudienceEquityBMWTerm
database: Sonic_DW
type: procedure
schema: dbo
owner: Data Team
...
Sample Call :
    EXEC [Sonic_DW].[dbo].[usp_FBCustomAudienceEquityBMWTerm]


CREATE OR ALTER By			CREATE OR ALTER Date	   CREATE OR ALTER Notes
---------------	----------	   ---------------------
Jay				2020-09-22	   CREATE OR ALTERed SP to insert Audience IDs which we send everyday to Facebook

*/


CREATE     PROCEDURE [dbo].[usp_FBCustomAudienceEquityBMWTerm]
...
SELECT S.AudienceID,
          ...
          @MetaSourceSystemID,
          @ETLExecutionID
         FROM ETL_Staging.[dbo].[StgFBAudienceEquityBMWTerm] AS S;
     END;
--END of SP
