...
BEGIN
	DECLARE @Profile NVARCHAR(MAX) = 'Sonic ETL Mail Profile' --@Profile
		...
		--'amrendra.kumar@sonicautomotive.com;Bedanta.Bordoloi@sonicautomotive.com;Bhramar.Chandrakar@sonicautomotive.com'
		,@Subject NVARCHAR(MAX) = 'Status of DIM_FocusCustomer Load'
		,@Body_Line1 NVARCHAR(MAX) = 'DIM_FocusCustomer Load Summary'
