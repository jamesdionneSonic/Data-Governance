---
name: usp_Date_FixedOps_SameLastMonth_Recreate
database: Sonic_DW
type: procedure
schema: dbo
owner: Data Team
...
- **dbo.Date_FixedOps_SameLastMonth** (U )
- **dbo.Dim_Date** (U )
...
-- ===============================================================================================================
CREATE PROCEDURE dbo.usp_Date_FixedOps_SameLastMonth_Recreate
AS
BEGIN
	...
	TRUNCATE TABLE dbo.Date_FixedOps_SameLastMonth;
	...
	With prebase as (
						...
						from dim_date
						where FOpsDaysMonth is not null /* only include dates where we have determined the FOpsDays*/
					)
	, base as (
										...
										left outer join base d
											on b.LastMonthYear = d.CalendarYear
											 ...
											 and case	when b.LastDay = 1
														...
														else b.FixedOpsDayMTD end >= d.FixedOpsDayMTD
	...
	INSERT INTO dbo.Date_FixedOps_SameLastMonth
