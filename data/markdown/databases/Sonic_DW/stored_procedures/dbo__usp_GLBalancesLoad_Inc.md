...
-- Modifications:	NAME		DATE		DESCRIPTION
					...
					sudip		7-6-2018    added statCount,YTDStatCount and BalAsOfStatCount columns to Fact_GLBalances
--		 ===========================================================================================================================================================================================================
*/
CREATE PROCEDURE [dbo].[usp_GLBalancesLoad_Inc]
AS
       ...
       while @BalanceForDate <= @MaxRunDate
              begin
                    ...
                    --------------------------------------------------------------------------------------------------------------
                     , CTA as
								 (
									 select
										   ...
										   SUM(isnull(StatCount,0)) as StatCount
									 from
                     ...
                     insert into Sonic_DW.dbo.Fact_GLBalances (EntityKey,AccountKey,MonthBeginDateKey,BalanceForDateKey,YTD,PostingAmount,BalAsOf,StatCount,YTDStatCount,BalAsOfStatCount,[User_ID],                                                                    -- Meta_Src_Sys_ID,
					 ...
					 select
                           ...
                           , isnull(EE.YTD,0) + isnull(AA.PostingAmount,0) as BalAsOf
						   , isnull(AA.StatCount,0)					as StatCount
                           , isnull(EE.YTDStatCount,0)				as YTDStatCount
                           , isnull(EE.YTDStatCount,0) + isnull(AA.StatCount,0) as BalAsOfStatCount
                           ,SYSTEM_USER
                          -- ,1
                           ,'D1-SSIS-01'
