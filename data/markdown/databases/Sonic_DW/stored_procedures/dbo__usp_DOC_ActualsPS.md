...
- **dbo.vw_Dim_AccountPS** (V )
- **dbo.vw_Doc_AccountGroupingPS** (V )
- **dbo.vw_Fact_PowersportsSoldUnits** (V )
...
-- =============================================
CREATE PROCEDURE [dbo].[usp_DOC_ActualsPS]
