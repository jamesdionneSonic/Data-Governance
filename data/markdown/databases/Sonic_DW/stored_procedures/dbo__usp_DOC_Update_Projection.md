...
| `@ComputerEquip`        | varchar | No     | No      |
| `@LoanerVehicle`        | varchar | No     | No      |
| `@BadDebt`              | varchar | No     | No      |
| `@OtherSalaries`        | varchar | No     | No      |
| `@CompensationClerical` | varchar | No     | No      |
| `@PayrollTaxes`         | varchar | No     | No      |
| `@AbsenteeWages`        | varchar | No     | No      |
| `@EmployeeBenefits`     | varchar | No     | No      |
| `@XmasParty`            | varchar | No     | No      |
| `@FourK`                | varchar | No     | No      |
| `@WorkersComp`          | varchar | No     | No      |
| `@UninsuredLosses`      | varchar | No     | No      |
| `@Overhead`             | varchar | No     | No      |
| `@OtherIncDed`          | varchar | No     | No      |
| `@FOCompGross`          | varchar | No     | No      |
| `@ContractComp`         | varchar | No     | No      |
| `@FleetGross`           | varchar | No     | No      |
| `@PFB`                  | varchar | No     | No      |
| `@AdvCredit`            | varchar | No     | No      |
| `@OtherOutsideServ`     | varchar | No     | No      |
| `@CreditCardFees`       | varchar | No     | No      |
| `@OnSiteMeals`          | varchar | No     | No      |
| `@CustomerConv`         | varchar | No     | No      |
| `@Legal`                | varchar | No     | No      |
| `@OfficeSupplies`       | varchar | No     | No      |
| `@DataProcessing`       | varchar | No     | No      |
| `@TravelEnt`            | varchar | No     | No      |
| `@ManagedRepairsMaint`  | varchar | No     | No      |
| `@RepairsMaint`         | varchar | No     | No      |
| `@PropertyTax`          | varchar | No     | No      |
| `@PersonalPropertyTax`  | varchar | No     | No      |
| `@SonicIT`              | varchar | No     | No      |
| `@CommInsLosses`        | varchar | No     | No      |
