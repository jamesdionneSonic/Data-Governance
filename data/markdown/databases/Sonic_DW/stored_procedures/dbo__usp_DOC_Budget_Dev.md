...
-- =============================================
CREATE PROCEDURE [dbo].[usp_DOC_Budget_Dev]
...
TRUNCATE TABLE [dbo].[Doc_Budget_Dev]


INSERT INTO [dbo].[Doc_Budget_Dev]
...
FROM	(SELECT [Fact_HFM_Key]
  ...
  FROM [dbo].[vw_Fact_HFMBudget])	a11
	...
	JOIN	(SELECT AccountMgmtKey, GroupElementSort
			FROM [V1-SQL-01\INST1].[Sonic_DW].dbo.Dim_AccountMgmtGrouping
			WHERE GroupID = 11)	a12
		ON 	(a11.[AccountMgmtKey] = a12.[AccountMgmtKey])
	JOIN [V1-SQL-01\INST1].[Sonic_DW].dbo.Dim_DOCMetrics a13
...
INSERT INTO [dbo].[Doc_Budget_Dev]
	...
	JOIN [V1-SQL-01\INST1].[Sonic_DW].dbo.Dim_DOCMetrics a12
			ON a11.MetricID = a12.GroupElementSort

END

--TRUNCATE TABLE [V1-SQL-01\INST1].[Sonic_DW].dbo.[Doc_Budget]

INSERT INTO [V1-SQL-01\INST1].[Sonic_DW].dbo.[Doc_Budget]
SELECT * FROM [dbo].[Doc_Budget_Dev]
```
