---
name: usp_FBCustomAudienceMercedesAutobahn
database: Sonic_DW
type: procedure
schema: dbo
owner: Data Team
...
Create Desc: This procedure Merge's audience IDs which we send everyday to Facebook
*/

 CREATE     PROCEDURE [dbo].[usp_FBCustomAudienceMercedesAutobahn] (
...
BEGIN
	...
	SELECT S.AudienceID
		...
		,@MetaSourceSystemID
		,@ETLExecutionID
	FROM ETL_Staging.[dbo].[StgFBAudienceMercedesAutobahn] AS S;
END;
--END of SP
