...
depends_on:
  ...
  - vwFloorPlanCIT_up
  - vwFloorPlanInventory
  - vwFloorPlanPayoffBalance
dependency_count: 4
parameter_count: 1
...
- **dbo.Syndicate_Floorplan_Payoff_up** (U )
- **dbo.vwFloorPlanCIT_up** (V )
- **dbo.vwFloorPlanInventory** (V )
- **dbo.vwFloorPlanPayoffBalance** (V )
...
CREATE procedure [dbo].[uspFloorPlanPayoff_up] (
...
FROM   dbo.vwFloorPlanPayoffBalance f
        ...
        LEFT JOIN dbo.vwFloorPlanCIT_up c
...
insert into [dbo].[Syndicate_Floorplan_Payoff_up] (
	Account,
