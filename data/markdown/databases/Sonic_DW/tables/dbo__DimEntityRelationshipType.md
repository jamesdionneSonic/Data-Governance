---
name: DimEntityRelationshipType
database: Sonic_DW
type: table
schema: dbo
owner: Data Team
...
depends_on:
  ...
  - DimEntityRelationship83_GA_Deletes
  - DimEntityRelationshipBkp20211104
  - DimEntityRelationship
  - DimEntityRelationship83_GA_Deletes
  - DimEntityRelationshipBkp20211104
row_count: 0
...
| `RelationshipTypeDescription` | nvarchar         | ✓        |          |         |             |
...
- **column_match**: dbo.DimEntityRelationship83_GA_Deletes → dbo.DimEntityRelationshipType
  ...
  - Evidence: Exact column name match: "relationshipid" in both tables
  - Column: `RelationshipId` → `RelationshipId`
- **column_match**: dbo.DimEntityRelationshipBkp20211104 → dbo.DimEntityRelationshipType
  - Confidence: 80%
  - Evidence: Exact column name match: "relationshipid" in both tables
  - Column: `RelationshipId` → `RelationshipId`
- **column_match**: dbo.DimEntityRelationship → dbo.DimEntityRelationshipType
