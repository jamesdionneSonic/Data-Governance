---
name: SalesTranAso_FI_ChargebackFinal
database: Sonic_DW
type: table
schema: dbo
owner: Data Team
...
- **column_match**: dbo.SalesTranAso_FI_Chargeback → dbo.SalesTranAso_FI_ChargebackFinal
  - Confidence: 80%
  - Evidence: Exact column name match: "timeclockid" in both tables
  - Column: `TimeClockID` → `TimeClockID`
- **column_match**: dbo.SalesTranAso_FI_ChargebackFinal → dbo.temp
  - Confidence: 80%
  - Evidence: Exact column name match: "timeclockid" in both tables
  - Column: `TimeClockID` → `TimeClockID`
