...
- **Primary Key**: PK_BT_DimChecklistQuestions
  - Columns: ChecklistQuestionID

## Indexes

- **PK_BT_DimChecklistQuestions** (CLUSTERED)
  - Unique: Yes
  - Primary Key: Yes
  - Key Columns: ChecklistQuestionID ASC
