---
name: SalesTranAssociate_Inbound
database: Sonic_DW
type: table
schema: dbo
owner: Data Team
...
- **IX_SalesTranAssociate_Inbound_EntBrand_MetaLoadDate** (NONCLUSTERED)
  - Unique: No
  - Primary Key: No
  - Key Columns: EntBrand ASC, Meta_loaddate ASC
  - Included Columns: CDK_companyid
...
- **column_match**: dbo.SalesTranAssociate_Inbound → dbo.SalesTranAssociate_Inbound_1122
  - Confidence: 80%
  - Evidence: Exact column name match: "id" in both tables
  - Column: `ID` → `ID`
- **column_match**: dbo.SalesTranAssociate_Inbound → dbo.SalesTranAssociate_Inbound_New
  - Confidence: 80%
  - Evidence: Exact column name match: "id" in both tables
  - Column: `ID` → `ID`
- **column_match**: dbo.SalesTranAssociate_Inbound → dbo.SalesTranAssociate_Inbound_Oct2024
  - Confidence: 80%
  - Evidence: Exact column name match: "id" in both tables
  - Column: `ID` → `ID`
- **column_match**: dbo.SalesTranAssociate_Inbound → dbo.SalesTranAssociate_Inbound_Oct20241
  - Confidence: 80%
  - Evidence: Exact column name match: "id" in both tables
  - Column: `ID` → `ID`
- **column_match**: dbo.SalesTranAssociate_Inbound → dbo.SalesTranAssociate_Inbound_Oct2024b
  - Confidence: 80%
  - Evidence: Exact column name match: "id" in both tables
  - Column: `ID` → `ID`
- **column_match**: dbo.SalesTranAssociate_Inbound → dbo.SalesTranAssociate_Inbound_testing
  - Confidence: 80%
  - Evidence: Exact column name match: "id" in both tables
  - Column: `ID` → `ID`
