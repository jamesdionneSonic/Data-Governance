---
name: SalesTranAssociate_Inbound_Oct2024b
database: Sonic_DW
type: table
schema: dbo
owner: Data Team
...
- **column_match**: dbo.SalesTranAssociate_Inbound → dbo.SalesTranAssociate_Inbound_Oct2024b
  ...
  - Column: `ID` → `ID`
- **column_match**: dbo.SalesTranAssociate_Inbound_1122 → dbo.SalesTranAssociate_Inbound_Oct2024b
  - Confidence: 80%
  - Evidence: Exact column name match: "id" in both tables
  - Column: `ID` → `ID`
- **column_match**: dbo.SalesTranAssociate_Inbound_New → dbo.SalesTranAssociate_Inbound_Oct2024b
  - Confidence: 80%
  - Evidence: Exact column name match: "id" in both tables
  - Column: `ID` → `ID`
- **column_match**: dbo.SalesTranAssociate_Inbound_Oct2024 → dbo.SalesTranAssociate_Inbound_Oct2024b
  - Confidence: 80%
  - Evidence: Exact column name match: "id" in both tables
  - Column: `ID` → `ID`
- **column_match**: dbo.SalesTranAssociate_Inbound_Oct20241 → dbo.SalesTranAssociate_Inbound_Oct2024b
  ...
  - Evidence: Exact column name match: "id" in both tables
  - Column: `ID` → `ID`
- **column_match**: dbo.SalesTranAssociate_Inbound_Oct2024b → dbo.SalesTranAssociate_Inbound_testing
  - Confidence: 80%
  - Evidence: Exact column name match: "id" in both tables
  - Column: `ID` → `ID`
