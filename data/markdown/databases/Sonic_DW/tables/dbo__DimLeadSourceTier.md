...
- **Primary Key**: Pk_LeadSourceTier_LeadSourceTierID
  - Columns: LeadSourceTierID

## Indexes

- **Pk_LeadSourceTier_LeadSourceTierID** (CLUSTERED)
  - Unique: Yes
  - Primary Key: Yes
  - Key Columns: LeadSourceTierID ASC
