...
- **Primary Key**: vw_GA_Social_CombinedPK
  - Columns: vwGASocialCombinedID

## Indexes

- **vw_GA_Social_CombinedPK** (CLUSTERED)
  - Unique: Yes
  - Primary Key: Yes
  - Key Columns: vwGASocialCombinedID ASC
