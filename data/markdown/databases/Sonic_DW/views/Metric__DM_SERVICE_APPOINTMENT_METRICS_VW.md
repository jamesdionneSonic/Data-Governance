---
name: DM_SERVICE_APPOINTMENT_METRICS_VW
database: Sonic_DW
type: view
schema: Metric
owner: Data Team
...
CREATE VIEW [Metric].[DM_SERVICE_APPOINTMENT_METRICS_VW]
AS
...
FROM Metric.EDWH_METRIC_TBL AS M
	...
	inner JOIN Metric.DIM_METRIC_ATTRIBUTE_TBL AS A ON M.DIM_METRIC_ATTRIBUTE_ID = A.DIM_METRIC_ATTRIBUTE_ID
	inner JOIN Metric.DIM_DATE_TBL AS DT ON M.METRIC_CAPTURE_DATE = DT.FULL_DATE
WHERE (MT.METRIC_TYPE = 'Turbo_Service_Appointments')) AS BASE_DATA
