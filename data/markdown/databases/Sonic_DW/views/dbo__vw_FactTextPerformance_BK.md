---
name: vw_FactTextPerformance_BK
database: Sonic_DW
type: view
schema: dbo
owner: Data Team
...
CREATE     VIEW [dbo].[vw_FactTextPerformance_BK]
AS
 ...
 (
	...
	INNER JOIN Sonic_DW.dbo.Dim_Date sd (NOLOCK)
		ON sd.CalendarYearMonth = LEFT(dtp.ProspectInDate,7)
		AND sd.IsFirstDayOfMonth = 'Y'
	INNER JOIN Sonic_DW.dbo.Dim_Date ed (NOLOCK)
