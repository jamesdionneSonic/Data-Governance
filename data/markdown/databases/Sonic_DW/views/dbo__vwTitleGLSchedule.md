...
inner join [Sonic_DW].[dbo].[Dim_Journal] j -- ADDED 02/21/2022
on s.journalkey = j.journalkey
WHERE CurrentMonthKey between CONVERT(char(8), DATEADD(DAY,1,EOMONTH(DATEADD(mm,-1,getdate()),-1)), 112) and CONVERT(char(8), DATEADD(DAY,1,EOMONTH(DATEADD(mm,0,getdate()),-1)),112)
and AccAccount in ('2400', '2401', '2402', '2403', '2404', '2405','2320','2340','2605') --inventory accounts
and e.entcoatype = 'Dealership'
and e.entActive = 'Active'
and e.entdealerlvl1 <> 'Central Buying Solution'------- filter out in the report
and j.JrnJournalid not in ('30', '31', '32', '33', '34', '35')
