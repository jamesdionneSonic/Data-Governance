...
| `Meta_FileDate`         | date     |          |             |
| `Meta_UpdateDate`       | datetime |          |             |
| `Meta_LoadDate`         | datetime |          |             |
| `Meta_ComputerName`     | nvarchar |          |             |
| `Meta_UserID`           | nvarchar |          |             |
| `Meta_SourceSystemName` | nvarchar |          |             |
| `Meta_SrcSysID`         | nvarchar |          |             |
| `ETLExecutionID`        | nvarchar |          |             |
| `ApprApptsDue`          | int      | ✓        |             |
| `ApprApptsShown`        | int      | ✓        |             |
| `DeliveryApptsDue`      | int      | ✓        |             |
| `DeliveryApptsShown`    | int      | ✓        |             |
| `EntityKey`             | int      | ✓        |             |
| `GroupName`             | varchar  | ✓        |             |
