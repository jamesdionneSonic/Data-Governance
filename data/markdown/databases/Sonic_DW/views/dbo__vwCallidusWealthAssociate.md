---
name: vwCallidusWealthAssociate
database: Sonic_DW
type: view
schema: dbo
owner: Data Team
...
CREATE view [dbo].[vwCallidusWealthAssociate] as
...
GM as (
   ...
   --GM records for secondary locations are Unioned to the main query down below.
					SELECT r.entitykey
                     ...
                     FROM   [Sonic_DW].[dbo].[DimAssociate_09012023] a
						...
						LEFT JOIN DimEntityRelationshipType t
                          ...
                          left join Sonic_dw.dbo.[DimAssociate_09012023] ca on ca.asoemployeenumber = r.integerfield

                     WHERE  a.asojobfamily = '01. General Managers'
                                  AND a.meta_rowiscurrent = 'Y'
								  	and a.ETLExecution_ID = 05162024
								  ...
								  and ca.ETLExecution_ID = 05162024
...
Oldsup as (
					select dim.AssociateKey, sup.AsoEmployeeNumber, sup.AsoSupervisorID, sup.AsoSupervisorName
                     from   (
                       ...
                       from   dbo.[DimAssociate_09012023]
                       where  meta_rowiscurrent = 'Y'
					   	and ETLExecution_ID = 05162024
...
FROM   [dbo].[DimAssociate_09012023] a
...
UNION --below are the gm records for secondary locations not in Fusion
        ...
        join Sonic_dw.dbo.[DimAssociate_09012023] ca
