---
name: vw_Dim_Dealership_Powersports
database: Sonic_DW
type: view
schema: dbo
owner: Data Team
...
```sql
CREATE VIEW dbo.vw_Dim_Dealership_Powersports
AS
SELECT        e.EntDealerLvl1, e.EntDealerLvl2, e.EntStoreBrand, e.EntDFODRegion, e.EntDFIDRegion, e.EntRegion, e.EntAddressState, e.EntEssCode, e.EntActive, e.EntBrandGroup AS EntStoreBrandGroup, e.EntAccountingPrefix,
                         e.EntCora_Account_ID, e.EntADPCompanyID, e.EntDefaultDlrshpLvl1, e.EntSubRegion, e.EntLineOfBusiness, MAX(d2.EntityKey) AS DealershipLvl2EntityKey, MAX(d1.EntityKey) AS DealershipLvl1EntityKey, e.EntBrand
...
WHERE        (e.EntDefaultDlrshpLvl1 = '1') AND (e.EntLineOfBusiness = 'Powersports') AND (e.EntEntityType = 'Dealership') OR
                         (e.EntDefaultDlrshpLvl1 = '1') AND (e.EntEntityType = 'Dealership') AND (e.EntBrand = 'Tactical')
GROUP BY e.EntDealerLvl1, e.EntStoreBrand, e.EntDFODRegion, e.EntDFIDRegion, e.EntRegion, e.EntAddressState, e.EntEssCode, e.EntActive, e.EntBrandGroup, e.EntAccountingPrefix, e.EntCora_Account_ID, e.EntADPCompanyID,
                         e.EntDealerLvl2, e.EntDefaultDlrshpLvl1, e.EntSubRegion, e.EntLineOfBusiness, e.EntityKey, e.EntBrand
