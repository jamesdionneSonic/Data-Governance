...
| `Age`                       | int      | ✓        |             |
| `AssignedFlag`              | int      |          |             |
| `AssignedFlag_old`          | int      |          |             |
| `BackCostAmount`            | money    | ✓        |             |
| `BackGross`                 | money    | ✓        |             |
| `BackSale`                  | money    | ✓        |             |
| `CalendarYearMonth`         | char     |          |             |
| `CertifiedFlag`             | varchar  | ✓        |             |
| `Chargebacks`               | money    | ✓        |             |
| `Chargebacks_Over90`        | money    | ✓        |             |
| `Chargebacks_Under90`       | money    | ✓        |             |
| `ContractDate`              | date     |          |             |
| `Control2`                  | varchar  | ✓        |             |
| `COS_Adj`                   | money    | ✓        |             |
| `CustomerKey`               | int      | ✓        |             |
...
| `FI_Net`                    | money    | ✓        |             |
| `FrontCostAmount`           | money    | ✓        |             |
| `FrontGross`                | money    | ✓        |             |
| `FrontGross_PackDocFactory` | money    | ✓        |             |
| `FrontSaleAmount`           | money    | ✓        |             |
| `LenderKey`                 | int      | ✓        |             |
| `memo_frontweowesnet`       | numeric  | ✓        |             |
| `Memo_Incentives`           | money    | ✓        |             |
| `memo_totaltradesover`      | numeric  | ✓        |             |
| `OtherAdj`                  | money    | ✓        |             |
| `Pack`                      | money    | ✓        |             |
