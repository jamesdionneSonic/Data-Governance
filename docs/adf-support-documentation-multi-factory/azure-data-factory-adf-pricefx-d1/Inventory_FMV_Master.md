# Inventory_FMV_Master

Generated: 2026-06-29T10:58:59.541Z
...
Inventory_FMV_Master is an ADF orchestrator in adf-pricefx-d1. If Inventory_FMV_Master fails or becomes stale, dependent ADF loads, files, datasets, or downstream reporting may be incomplete until the failed run is diagnosed and rerun through the approved parent path. Start troubleshooting by checking the latest Inventory_FMV_Master parent run and identify the first failed child activity.
...
| Platform              | ADF                                                                                                                                                                                 |
| Asset type            | Pipeline                                                                                                                                                                            |
| Native path           | `/subscriptions/bee9b611-da99-4cfc-9fb7-50f1359e5ca2/resourceGroups/rg-data-warehouse-prod/providers/Microsoft.DataFactory/factories/adf-PriceFx-D1/pipelines/Inventory_FMV_Master` |
| Support role          | orchestrator                                                                                                                                                                        |
| Business process      | adf-pricefx-d1 pipeline execution                                                                                                                                                   |
| Primary source        | not surfaced in metadata                                                                                                                                                            |
| Primary target/output | Inventory_FMV_PriceFxDB, Inventory_FMV_PriceFx                                                                                                                                      |
| Schedule or trigger   | Tr_Inv_FMV_Daily                                                                                                                                                                    |
...
1. Check the latest Inventory_FMV_Master parent run and identify the first failed child activity.
...
4. Confirm target datasets or child pipelines completed: Inventory_FMV_PriceFxDB, Inventory_FMV_PriceFx.
...
| Child pipelines   | Inventory_FMV_PriceFxDB, Inventory_FMV_PriceFx                                                                                                                                    |
...
| ------------------------------------ | ------------------------ | ------------------------ | ------------------------ |
| Inv_fmv_PriceFXDB                    | ExecutePipeline          | not surfaced in metadata | not surfaced in metadata |
| Inv_fmv_PriceFx                      | ExecutePipeline          | not surfaced in metadata | not surfaced in metadata |
...
| Set Inventory FMV To PriceFx Failure | SqlServerStoredProcedure | not surfaced in metadata | not surfaced in metadata |
| Set Inventory fmv Get Data Failure   | SqlServerStoredProcedure | not surfaced in metadata | not surfaced in metadata |
