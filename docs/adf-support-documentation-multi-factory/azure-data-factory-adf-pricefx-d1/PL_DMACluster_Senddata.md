# PL_DMACluster_Senddata

Generated: 2026-06-29T10:58:59.562Z
...
PL_DMACluster_Senddata is an ADF child pipeline in adf-pricefx-d1. If PL_DMACluster_Senddata fails or becomes stale, dependent ADF loads, files, datasets, or downstream reporting may be incomplete until the failed run is diagnosed and rerun through the approved parent path. Start troubleshooting by checking the parent pipeline that called PL_DMACluster_Senddata; do not start the child with blank operational parameters.
...
| Platform              | ADF                                                                                                                                                                                   |
| Asset type            | Pipeline                                                                                                                                                                              |
| Native path           | `/subscriptions/bee9b611-da99-4cfc-9fb7-50f1359e5ca2/resourceGroups/rg-data-warehouse-prod/providers/Microsoft.DataFactory/factories/adf-PriceFx-D1/pipelines/PL_DMACluster_Senddata` |
| Support role          | child pipeline                                                                                                                                                                        |
| Business process      | adf-pricefx-d1 pipeline execution                                                                                                                                                     |
| Primary source        | ds_pricefx_DMACluster                                                                                                                                                                 |
...
1. Check the parent pipeline that called PL_DMACluster_Senddata; do not start the child with blank operational parameters.
...
3. Confirm source datasets are available: ds_pricefx_DMACluster.
...
| Source datasets   | ds_pricefx_DMACluster                                                                                                                                                                                                  |
...
| ------------------------------------ | ------------------------ | ------------------------ | ------------------------ |
| cp_sftp_DMACluster                   | Copy                     | ds_pricefx_DMACluster    | DS_SFTP_US_EAST_1        |
