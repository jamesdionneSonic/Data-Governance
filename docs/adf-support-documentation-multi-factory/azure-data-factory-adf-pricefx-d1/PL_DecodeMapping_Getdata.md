# PL_DecodeMapping_Getdata

Generated: 2026-06-29T10:58:59.557Z
...
PL_DecodeMapping_Getdata is an ADF child pipeline in adf-pricefx-d1. If PL_DecodeMapping_Getdata fails or becomes stale, dependent ADF loads, files, datasets, or downstream reporting may be incomplete until the failed run is diagnosed and rerun through the approved parent path. Start troubleshooting by checking the parent pipeline that called PL_DecodeMapping_Getdata; do not start the child with blank operational parameters.
...
| Platform              | ADF                                                                                                                                                                                     |
| Asset type            | Pipeline                                                                                                                                                                                |
| Native path           | `/subscriptions/bee9b611-da99-4cfc-9fb7-50f1359e5ca2/resourceGroups/rg-data-warehouse-prod/providers/Microsoft.DataFactory/factories/adf-PriceFx-D1/pipelines/PL_DecodeMapping_Getdata` |
| Support role          | child pipeline                                                                                                                                                                          |
| Business process      | adf-pricefx-d1 pipeline execution                                                                                                                                                       |
| Primary source        | DS_SQL_vehiclemart                                                                                                                                                                      |
| Primary target/output | ds_pricefx_decodemapping                                                                                                                                                                |
...
1. Check the parent pipeline that called PL_DecodeMapping_Getdata; do not start the child with blank operational parameters.
...
3. Confirm source datasets are available: DS_SQL_vehiclemart.
4. Confirm target datasets or child pipelines completed: ds_pricefx_decodemapping.
...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Parent pipelines  | PL_PriceFx_DecodeMapping_Master                                                                                                                                                 |
| Child pipelines   | none surfaced                                                                                                                                                                   |
| Source datasets   | DS_SQL_vehiclemart                                                                                                                                                              |
| Target datasets   | ds_pricefx_decodemapping                                                                                                                                                        |
...
| cp_pricefx_DecodeMapping                | Copy                     | DS_SQL_vehiclemart       | ds_pricefx_decodemapping |
