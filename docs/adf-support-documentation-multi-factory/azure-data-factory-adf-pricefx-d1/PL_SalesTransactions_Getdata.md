# PL_SalesTransactions_Getdata

Generated: 2026-06-29T10:58:59.605Z
...
PL_SalesTransactions_Getdata is an ADF child pipeline in adf-pricefx-d1. If PL_SalesTransactions_Getdata fails or becomes stale, dependent ADF loads, files, datasets, or downstream reporting may be incomplete until the failed run is diagnosed and rerun through the approved parent path. Start troubleshooting by checking the parent pipeline that called PL_SalesTransactions_Getdata; do not start the child with blank operational parameters.
...
| Platform              | ADF                                                                                                                                                                                         |
| Asset type            | Pipeline                                                                                                                                                                                    |
| Native path           | `/subscriptions/bee9b611-da99-4cfc-9fb7-50f1359e5ca2/resourceGroups/rg-data-warehouse-prod/providers/Microsoft.DataFactory/factories/adf-PriceFx-D1/pipelines/PL_SalesTransactions_Getdata` |
...
1. Check the parent pipeline that called PL_SalesTransactions_Getdata; do not start the child with blank operational parameters.
...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| Parent pipelines  | PL_PriceFx_SalesTransactions_Master                                                                                                 |
