# PL_PriceFx_DMACluster_Master

Generated: 2026-06-29T10:58:59.591Z
...
| Platform              | ADF                                                                                                                                                                                         |
| Asset type            | Pipeline                                                                                                                                                                                    |
| Native path           | `/subscriptions/bee9b611-da99-4cfc-9fb7-50f1359e5ca2/resourceGroups/rg-data-warehouse-prod/providers/Microsoft.DataFactory/factories/adf-PriceFx-D1/pipelines/PL_PriceFx_DMACluster_Master` |
| Support role          | orchestrator                                                                                                                                                                                |
| Business process      | adf-pricefx-d1 pipeline execution                                                                                                                                                           |
| Primary source        | not surfaced in metadata                                                                                                                                                                    |
| Primary target/output | PL_DMACluster_Getdata, PL_DMACluster_Senddata                                                                                                                                               |
| Schedule or trigger   | Tr_DMACluster                                                                                                                                                                               |
...
1. Check the latest PL_PriceFx_DMACluster_Master parent run and identify the first failed child activity.
...
4. Confirm target datasets or child pipelines completed: PL_DMACluster_Getdata, PL_DMACluster_Senddata.
...
| Child pipelines   | PL_DMACluster_Getdata, PL_DMACluster_Senddata                                                                                                                                     |
...
| Execute DMACluster Getdata        | ExecutePipeline          | not surfaced in metadata | not surfaced in metadata |
| Execute DMACluster Senddata       | ExecutePipeline          | not surfaced in metadata | not surfaced in metadata |
| Set DMACluster Getdata Failure    | SqlServerStoredProcedure | not surfaced in metadata | not surfaced in metadata |
| Set DMACluster Senddata Failure   | SqlServerStoredProcedure | not surfaced in metadata | not surfaced in metadata |
