# Inventory_FMV_PriceFx

Generated: 2026-06-29T10:58:59.543Z
...
Inventory_FMV_PriceFx is an ADF child pipeline in adf-pricefx-d1. If Inventory_FMV_PriceFx fails or becomes stale, dependent ADF loads, files, datasets, or downstream reporting may be incomplete until the failed run is diagnosed and rerun through the approved parent path. Start troubleshooting by checking the parent pipeline that called Inventory_FMV_PriceFx; do not start the child with blank operational parameters.
...
| Platform              | ADF                                                                                                                                                                                  |
| Asset type            | Pipeline                                                                                                                                                                             |
| Native path           | `/subscriptions/bee9b611-da99-4cfc-9fb7-50f1359e5ca2/resourceGroups/rg-data-warehouse-prod/providers/Microsoft.DataFactory/factories/adf-PriceFx-D1/pipelines/Inventory_FMV_PriceFx` |
| Support role          | child pipeline                                                                                                                                                                       |
| Business process      | adf-pricefx-d1 pipeline execution                                                                                                                                                    |
| Primary source        | PriceFx_DB, DS_SQL_PriceFX                                                                                                                                                           |
...
1. Check the parent pipeline that called Inventory_FMV_PriceFx; do not start the child with blank operational parameters.
...
3. Confirm source datasets are available: PriceFx_DB, DS_SQL_PriceFX.
...
| Source datasets   | PriceFx_DB, DS_SQL_PriceFX                                                                                                                                                                                             |
...
| cp_inventoryFMV_to_pricefx           | Copy                     | DS_SQL_PriceFX           | DS_SFTP_US_EAST_1        |
