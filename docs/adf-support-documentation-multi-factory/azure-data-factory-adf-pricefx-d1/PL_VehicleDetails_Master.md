# PL_VehicleDetails_Master

Generated: 2026-06-29T10:58:59.612Z
...
PL_VehicleDetails_Master is an ADF orchestrator in adf-pricefx-d1. If PL_VehicleDetails_Master fails or becomes stale, dependent ADF loads, files, datasets, or downstream reporting may be incomplete until the failed run is diagnosed and rerun through the approved parent path. Start troubleshooting by checking the latest PL_VehicleDetails_Master parent run and identify the first failed child activity.
...
| Platform              | ADF                                                                                                                                                                                     |
| Asset type            | Pipeline                                                                                                                                                                                |
| Native path           | `/subscriptions/bee9b611-da99-4cfc-9fb7-50f1359e5ca2/resourceGroups/rg-data-warehouse-prod/providers/Microsoft.DataFactory/factories/adf-PriceFx-D1/pipelines/PL_VehicleDetails_Master` |
| Support role          | orchestrator                                                                                                                                                                            |
| Business process      | adf-pricefx-d1 pipeline execution                                                                                                                                                       |
| Primary source        | not surfaced in metadata                                                                                                                                                                |
| Primary target/output | PL_VehicleDetails_GetData, PL_VehicleDetails_SendFile                                                                                                                                   |
| Schedule or trigger   | Tr_VehicleDetails_Daily                                                                                                                                                                 |
...
1. Check the latest PL_VehicleDetails_Master parent run and identify the first failed child activity.
...
4. Confirm target datasets or child pipelines completed: PL_VehicleDetails_GetData, PL_VehicleDetails_SendFile.
...
| Child pipelines   | PL_VehicleDetails_GetData, PL_VehicleDetails_SendFile                                                                                                                             |
...
| ----------------------------------- | ------------------------ | ------------------------ | ------------------------ |
| Execute VehicleDetails GetData      | ExecutePipeline          | not surfaced in metadata | not surfaced in metadata |
| Execute VehicleDetails SendFile     | ExecutePipeline          | not surfaced in metadata | not surfaced in metadata |
...
| Set VehicleDetails GetData Failure  | SqlServerStoredProcedure | not surfaced in metadata | not surfaced in metadata |
| Set VehicleDetails SendFile Failure | SqlServerStoredProcedure | not surfaced in metadata | not surfaced in metadata |
