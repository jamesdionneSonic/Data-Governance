# PL_PriceFx_SalesTransactions_Master

Generated: 2026-06-29T10:58:59.602Z
...
| Platform              | ADF                                                                                                                                                                                                |
| Asset type            | Pipeline                                                                                                                                                                                           |
| Native path           | `/subscriptions/bee9b611-da99-4cfc-9fb7-50f1359e5ca2/resourceGroups/rg-data-warehouse-prod/providers/Microsoft.DataFactory/factories/adf-PriceFx-D1/pipelines/PL_PriceFx_SalesTransactions_Master` |
| Support role          | orchestrator                                                                                                                                                                                       |
| Business process      | adf-pricefx-d1 pipeline execution                                                                                                                                                                  |
| Primary source        | not surfaced in metadata                                                                                                                                                                           |
| Primary target/output | PL_SalesTransactions_Getdata, PL_SalesTransactions_Senddata                                                                                                                                        |
| Schedule or trigger   | Tr_SalesTransactions_Daily                                                                                                                                                                         |
...
1. Check the latest PL_PriceFx_SalesTransactions_Master parent run and identify the first failed child activity.
...
4. Confirm target datasets or child pipelines completed: PL_SalesTransactions_Getdata, PL_SalesTransactions_Senddata.
...
| Child pipelines   | PL_SalesTransactions_Getdata, PL_SalesTransactions_Senddata                                                                                                                       |
...
| Execute SalesTransactions Getdata      | ExecutePipeline          | not surfaced in metadata | not surfaced in metadata |
| Execute SalesTransactions Senddata     | ExecutePipeline          | not surfaced in metadata | not surfaced in metadata |
| Set SalesTransactions Getdata Failure  | SqlServerStoredProcedure | not surfaced in metadata | not surfaced in metadata |
| Set SalesTransactions Senddata Failure | SqlServerStoredProcedure | not surfaced in metadata | not surfaced in metadata |
