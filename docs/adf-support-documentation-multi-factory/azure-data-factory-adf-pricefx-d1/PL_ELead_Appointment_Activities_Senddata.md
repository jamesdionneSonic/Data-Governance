# PL_ELead_Appointment_Activities_Senddata

Generated: 2026-06-29T10:58:59.564Z
...
PL_ELead_Appointment_Activities_Senddata is an ADF child pipeline in adf-pricefx-d1. If PL_ELead_Appointment_Activities_Senddata fails or becomes stale, dependent ADF loads, files, datasets, or downstream reporting may be incomplete until the failed run is diagnosed and rerun through the approved parent path. Start troubleshooting by checking the parent pipeline that called PL_ELead_Appointment_Activities_Senddata; do not start the child with blank operational parameters.
...
| Platform              | ADF                                                                                                                                                                                                     |
| Asset type            | Pipeline                                                                                                                                                                                                |
| Native path           | `/subscriptions/bee9b611-da99-4cfc-9fb7-50f1359e5ca2/resourceGroups/rg-data-warehouse-prod/providers/Microsoft.DataFactory/factories/adf-PriceFx-D1/pipelines/PL_ELead_Appointment_Activities_Senddata` |
| Support role          | child pipeline                                                                                                                                                                                          |
| Business process      | adf-pricefx-d1 pipeline execution                                                                                                                                                                       |
| Primary source        | ds_pricefx_eleadappointmentactivities                                                                                                                                                                   |
...
This pipeline supports the adf-pricefx-d1 ADF process. Its available metadata shows 7 activity step(s), 0 child pipeline call(s), 1 source dataset reference(s), and 1 target dataset reference(s).

## Support Checks

1. Check the parent pipeline that called PL_ELead_Appointment_Activities_Senddata; do not start the child with blank operational parameters.
...
3. Confirm source datasets are available: ds_pricefx_eleadappointmentactivities.
...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| Parent pipelines  | PL_PriceFx_ELead_Appointment_Activities_Master                                                                                      |
| Child pipelines   | none surfaced                                                                                                                       |
| Source datasets   | ds_pricefx_eleadappointmentactivities                                                                                               |
...
| ----------------------------------- | ------------------------ | ------------------------------------- | ------------------------ |
| cp_sftp_elead_appointmentactivities | Copy                     | ds_pricefx_eleadappointmentactivities | DS_SFTP_US_EAST_1        |
