# PL_ELead_Vehicle_Senddata

Generated: 2026-06-29T10:58:59.570Z
...
PL_ELead_Vehicle_Senddata is an ADF child pipeline in adf-pricefx-d1. If PL_ELead_Vehicle_Senddata fails or becomes stale, dependent ADF loads, files, datasets, or downstream reporting may be incomplete until the failed run is diagnosed and rerun through the approved parent path. Start troubleshooting by checking the parent pipeline that called PL_ELead_Vehicle_Senddata; do not start the child with blank operational parameters.
...
| Platform              | ADF                                                                                                                                                                                      |
| Asset type            | Pipeline                                                                                                                                                                                 |
| Native path           | `/subscriptions/bee9b611-da99-4cfc-9fb7-50f1359e5ca2/resourceGroups/rg-data-warehouse-prod/providers/Microsoft.DataFactory/factories/adf-PriceFx-D1/pipelines/PL_ELead_Vehicle_Senddata` |
| Support role          | child pipeline                                                                                                                                                                           |
| Business process      | adf-pricefx-d1 pipeline execution                                                                                                                                                        |
| Primary source        | ds_pricefx_eleadvehicle                                                                                                                                                                  |
...
1. Check the parent pipeline that called PL_ELead_Vehicle_Senddata; do not start the child with blank operational parameters.
...
3. Confirm source datasets are available: ds_pricefx_eleadvehicle.
...
| ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Parent pipelines  | PL_PriceFx_ELead_Vehicle_Master                                                                                                                                                                                        |
| Child pipelines   | none surfaced                                                                                                                                                                                                          |
| Source datasets   | ds_pricefx_eleadvehicle                                                                                                                                                                                                |
...
| ------------------------------------ | ------------------------ | ------------------------ | ------------------------ |
| cp_sftp_elead_vehicle                | Copy                     | ds_pricefx_eleadvehicle  | DS_SFTP_US_EAST_1        |
