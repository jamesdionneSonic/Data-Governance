# Ep_salesTracker_Master

Generated: 2026-06-29T10:58:59.537Z
...
Ep_salesTracker_Master is an ADF orchestrator in adf-pricefx-d1. If Ep_salesTracker_Master fails or becomes stale, dependent ADF loads, files, datasets, or downstream reporting may be incomplete until the failed run is diagnosed and rerun through the approved parent path. Start troubleshooting by checking the latest Ep_salesTracker_Master parent run and identify the first failed child activity.
...
| Platform              | ADF                                                                                                                                                                                   |
| Asset type            | Pipeline                                                                                                                                                                              |
| Native path           | `/subscriptions/bee9b611-da99-4cfc-9fb7-50f1359e5ca2/resourceGroups/rg-data-warehouse-prod/providers/Microsoft.DataFactory/factories/adf-PriceFx-D1/pipelines/Ep_salesTracker_Master` |
| Support role          | orchestrator                                                                                                                                                                          |
| Business process      | adf-pricefx-d1 pipeline execution                                                                                                                                                     |
| Primary source        | not surfaced in metadata                                                                                                                                                              |
| Primary target/output | Ep_Sales_PriceFxDB, Ep_salesTracker_PriceFx                                                                                                                                           |
| Schedule or trigger   | EP_Sales_Tracker_Daily                                                                                                                                                                |
...
1. Check the latest Ep_salesTracker_Master parent run and identify the first failed child activity.
...
4. Confirm target datasets or child pipelines completed: Ep_Sales_PriceFxDB, Ep_salesTracker_PriceFx.
...
| Child pipelines   | Ep_Sales_PriceFxDB, Ep_salesTracker_PriceFx                                                                                                                                       |
...
| --------------------------------- | ------------------------ | ------------------------ | ------------------------ |
| EPST_PRiceFXDB                    | ExecutePipeline          | not surfaced in metadata | not surfaced in metadata |
| EPST_PriceFx                      | ExecutePipeline          | not surfaced in metadata | not surfaced in metadata |
...
| EPSales To PriceFx Failure        | SqlServerStoredProcedure | not surfaced in metadata | not surfaced in metadata |
| Set EPSales GetData Failure       | SqlServerStoredProcedure | not surfaced in metadata | not surfaced in metadata |
