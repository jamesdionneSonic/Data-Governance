# Autotrader_Manual_Evry15min

## Plain-English Summary

Autotrader_Manual_Evry15min is an ADF trigger in adf-vehiclemart-prod. It targets `AT_Auto_Trigger_ManualRun`. If Autotrader_Manual_Evry15min fails or becomes stale, dependent ADF loads, files, datasets, or downstream reporting may be incomplete until the failed run is diagnosed and rerun through the approved parent path. Start troubleshooting by checking trigger state, schedule, and the latest target pipeline run.
...
| Platform              | ADF                                                                                                                                                                                          |
| Asset type            | Trigger                                                                                                                                                                                      |
| Native path           | `/subscriptions/bee9b611-da99-4cfc-9fb7-50f1359e5ca2/resourceGroups/RG-VehicleMart-Prod/providers/Microsoft.DataFactory/factories/ADF-VehicleMart-Prod/triggers/Autotrader_Manual_Evry15min` |
...
| Primary target/output | AT_Auto_Trigger_ManualRun                                                                                                                                                                    |
| Schedule or trigger   | Minute every 15; time zone India Standard Time                                                                                                                                               |
...
| ---------------- | ------------------------- |
| Target pipelines | AT_Auto_Trigger_ManualRun |
...
Schedule: Minute every 15; time zone India Standard Time
