# PL_GoogleAds_Campaign_Master

Generated: 2026-06-29T10:58:59.142Z
...
PL_GoogleAds_Campaign_Master is an ADF orchestrator in adf-inbounddataetl-prod. If PL_GoogleAds_Campaign_Master fails or becomes stale, dependent ADF loads, files, datasets, or downstream reporting may be incomplete until the failed run is diagnosed and rerun through the approved parent path. Start troubleshooting by checking the latest PL_GoogleAds_Campaign_Master parent run and identify the first failed child activity.
...
| Platform              | ADF                                                                                                                                                                                                       |
| Asset type            | Pipeline                                                                                                                                                                                                  |
| Native path           | `/subscriptions/bee9b611-da99-4cfc-9fb7-50f1359e5ca2/resourceGroups/RG-InboundDataServices-Prod/providers/Microsoft.DataFactory/factories/ADF-InboundDataETL-Prod/pipelines/PL_GoogleAds_Campaign_Master` |
...
| Primary target/output | PL_GoogleAds_Campaign_IncrementalLoad                                                                                                                                                                     |
| Schedule or trigger   | trGoogleAdsDataLoad                                                                                                                                                                                       |
...
1. Check the latest PL_GoogleAds_Campaign_Master parent run and identify the first failed child activity.
...
4. Confirm target datasets or child pipelines completed: PL_GoogleAds_Campaign_IncrementalLoad.
...
| Child pipelines   | PL_GoogleAds_Campaign_IncrementalLoad |
