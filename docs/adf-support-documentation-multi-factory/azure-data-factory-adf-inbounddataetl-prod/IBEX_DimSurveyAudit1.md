# IBEX_DimSurveyAudit1

Generated: 2026-06-29T10:58:59.082Z
...
| Platform              | ADF                                                                                                                                                                                               |
| Asset type            | Pipeline                                                                                                                                                                                          |
| Native path           | `/subscriptions/bee9b611-da99-4cfc-9fb7-50f1359e5ca2/resourceGroups/RG-InboundDataServices-Prod/providers/Microsoft.DataFactory/factories/ADF-InboundDataETL-Prod/pipelines/IBEX_DimSurveyAudit1` |
| Support role          | child pipeline                                                                                                                                                                                    |
| Business process      | adf-inbounddataetl-prod pipeline execution                                                                                                                                                        |
| Primary source        | SqlIBEXSurveyResponseSource2                                                                                                                                                                      |
| Primary target/output | SqlIBEXSurveyResponseAuditStage1                                                                                                                                                                  |
...
1. Check the parent pipeline that called IBEX_DimSurveyAudit1; do not start the child with blank operational parameters.
2. Confirm parameters are supplied by the parent, trigger, or documented default path: not surfaced in metadata.
3. Confirm source datasets are available: SqlIBEXSurveyResponseSource2.
4. Confirm target datasets or child pipelines completed: SqlIBEXSurveyResponseAuditStage1.
...
| Source datasets   | SqlIBEXSurveyResponseSource2                                                         |
| Target datasets   | SqlIBEXSurveyResponseAuditStage1                                                     |
...
| SRC to STG                                | Copy                     | SqlIBEXSurveyResponseSource2 | SqlIBEXSurveyResponseAuditStage1 |
