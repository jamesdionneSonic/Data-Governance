# GoogleAds_STG_DataLoad_old

Generated: 2026-06-29T10:58:59.074Z
...
GoogleAds_STG_DataLoad_old is an ADF child pipeline in adf-inbounddataetl-prod. If GoogleAds_STG_DataLoad_old fails or becomes stale, dependent ADF loads, files, datasets, or downstream reporting may be incomplete until the failed run is diagnosed and rerun through the approved parent path. Start troubleshooting by checking the parent pipeline that called GoogleAds_STG_DataLoad_old; do not start the child with blank operational parameters.
...
| Platform              | ADF                                                                                                                                                                                                     |
| Asset type            | Pipeline                                                                                                                                                                                                |
| Native path           | `/subscriptions/bee9b611-da99-4cfc-9fb7-50f1359e5ca2/resourceGroups/RG-InboundDataServices-Prod/providers/Microsoft.DataFactory/factories/ADF-InboundDataETL-Prod/pipelines/GoogleAds_STG_DataLoad_old` |
...
1. Check the parent pipeline that called GoogleAds_STG_DataLoad_old; do not start the child with blank operational parameters.
...
| ----------------- | ----------------------------------------- |
| Parent pipelines  | PL_GoogleAds_Campaign_IncrementalLoad_old |
