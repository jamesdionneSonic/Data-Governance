...
Generated: 2026-06-29T10:58:59.153Z
...
| Platform              | ADF                                                                                                                                                                                             |
| Asset type            | Pipeline                                                                                                                                                                                        |
| Native path           | `/subscriptions/bee9b611-da99-4cfc-9fb7-50f1359e5ca2/resourceGroups/RG-InboundDataServices-Prod/providers/Microsoft.DataFactory/factories/ADF-InboundDataETL-Prod/pipelines/pl_mdp2adlsparquet` |
| Support role          | data movement                                                                                                                                                                                   |
| Business process      | adf-inbounddataetl-prod pipeline execution                                                                                                                                                      |
| Primary source        | SqlServerTable1                                                                                                                                                                                 |
| Primary target/output | ds_mdp2adlsparquet                                                                                                                                                                              |
...
1. Check the latest ADF run for pl_mdp2adlsparquet and confirm source and target datasets are available.
2. Confirm parameters are supplied by the parent, trigger, or documented default path: not surfaced in metadata.
3. Confirm source datasets are available: SqlServerTable1.
4. Confirm target datasets or child pipelines completed: ds_mdp2adlsparquet.
...
| Source datasets   | SqlServerTable1                  |
| Target datasets   | ds_mdp2adlsparquet               |
| Stored procedures | [dbo].[usp_MDPSample_Individual] |
...
| ------------------ | ---- | --------------- | ------------------ |
| cp_mdp2adlsparquet | Copy | SqlServerTable1 | ds_mdp2adlsparquet |
