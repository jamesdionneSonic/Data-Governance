...
Generated: 2026-06-29T10:58:59.133Z
...
pl_dms2adlsparquet is an ADF data movement in adf-inbounddataetl-prod. If pl_dms2adlsparquet fails or becomes stale, dependent ADF loads, files, datasets, or downstream reporting may be incomplete until the failed run is diagnosed and rerun through the approved parent path. Start troubleshooting by checking the latest ADF run for pl_dms2adlsparquet and confirm source and target datasets are available.
...
| Platform              | ADF                                                                                                                                                                                             |
| Asset type            | Pipeline                                                                                                                                                                                        |
| Native path           | `/subscriptions/bee9b611-da99-4cfc-9fb7-50f1359e5ca2/resourceGroups/RG-InboundDataServices-Prod/providers/Microsoft.DataFactory/factories/ADF-InboundDataETL-Prod/pipelines/pl_dms2adlsparquet` |
| Support role          | data movement                                                                                                                                                                                   |
| Business process      | adf-inbounddataetl-prod pipeline execution                                                                                                                                                      |
| Primary source        | ds_dms                                                                                                                                                                                          |
...
1. Check the latest ADF run for pl_dms2adlsparquet and confirm source and target datasets are available.
2. Confirm parameters are supplied by the parent, trigger, or documented default path: not surfaced in metadata.
3. Confirm source datasets are available: ds_dms.
...
| ------------------- | ---- | ------ | ---------- |
| cp_dms2adls_parquet | Copy | ds_dms | ds_parquet |
