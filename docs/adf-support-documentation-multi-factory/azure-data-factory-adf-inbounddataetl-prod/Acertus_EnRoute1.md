...
Generated: 2026-06-29T10:58:59.037Z
...
Acertus_EnRoute1 is an ADF orchestrator in adf-inbounddataetl-prod. If Acertus_EnRoute1 fails or becomes stale, dependent ADF loads, files, datasets, or downstream reporting may be incomplete until the failed run is diagnosed and rerun through the approved parent path. Start troubleshooting by checking the latest Acertus_EnRoute1 parent run and identify the first failed child activity.
...
| Platform              | ADF                                                                                                                                                                                           |
| Asset type            | Pipeline                                                                                                                                                                                      |
| Native path           | `/subscriptions/bee9b611-da99-4cfc-9fb7-50f1359e5ca2/resourceGroups/RG-InboundDataServices-Prod/providers/Microsoft.DataFactory/factories/ADF-InboundDataETL-Prod/pipelines/Acertus_EnRoute1` |
...
| Primary target/output | Acertus_InRoute_GetFiles2, Acertus_EP_InRoute_Staging2, Acertus_EP_InRoute_VendorData2                                                                                                        |
...
1. Check the latest Acertus_EnRoute1 parent run and identify the first failed child activity.
...
4. Confirm target datasets or child pipelines completed: Acertus_InRoute_GetFiles2, Acertus_EP_InRoute_Staging2, Acertus_EP_InRoute_VendorData2.
...
| Child pipelines   | Acertus_InRoute_GetFiles2, Acertus_EP_InRoute_Staging2, Acertus_EP_InRoute_VendorData2 |
