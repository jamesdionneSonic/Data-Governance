# LoadStandardRosterToVendorData1

Generated: 2026-06-29T10:58:59.101Z
...
LoadStandardRosterToVendorData1 is an ADF child pipeline in adf-inbounddataetl-prod. If LoadStandardRosterToVendorData1 fails or becomes stale, dependent ADF loads, files, datasets, or downstream reporting may be incomplete until the failed run is diagnosed and rerun through the approved parent path. Start troubleshooting by checking the parent pipeline that called LoadStandardRosterToVendorData1; do not start the child with blank operational parameters.
...
| Platform              | ADF                                                                                                                                                                                                          |
| Asset type            | Pipeline                                                                                                                                                                                                     |
| Native path           | `/subscriptions/bee9b611-da99-4cfc-9fb7-50f1359e5ca2/resourceGroups/RG-InboundDataServices-Prod/providers/Microsoft.DataFactory/factories/ADF-InboundDataETL-Prod/pipelines/LoadStandardRosterToVendorData1` |
| Support role          | child pipeline                                                                                                                                                                                               |
| Business process      | adf-inbounddataetl-prod pipeline execution                                                                                                                                                                   |
| Primary source        | Verint_Staging_StandardRoster_ds2                                                                                                                                                                            |
| Primary target/output | Verint_StandardRoster_VendorData_ds1                                                                                                                                                                         |
...
1. Check the parent pipeline that called LoadStandardRosterToVendorData1; do not start the child with blank operational parameters.
2. Confirm parameters are supplied by the parent, trigger, or documented default path: not surfaced in metadata.
3. Confirm source datasets are available: Verint_Staging_StandardRoster_ds2.
4. Confirm target datasets or child pipelines completed: Verint_StandardRoster_VendorData_ds1.
...
| Source datasets   | Verint_Staging_StandardRoster_ds2    |
| Target datasets   | Verint_StandardRoster_VendorData_ds1 |
...
| ----------------------------------- | ---- | --------------------------------- | ------------------------------------ |
| Copy Standard Roster to Vendor Data | Copy | Verint_Staging_StandardRoster_ds2 | Verint_StandardRoster_VendorData_ds1 |
