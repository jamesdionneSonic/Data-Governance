...
Generated: 2026-06-29T10:58:59.034Z
...
Acertus_Delivery2 is an ADF orchestrator in adf-inbounddataetl-prod. If Acertus_Delivery2 fails or becomes stale, dependent ADF loads, files, datasets, or downstream reporting may be incomplete until the failed run is diagnosed and rerun through the approved parent path. Start troubleshooting by checking the latest Acertus_Delivery2 parent run and identify the first failed child activity.
...
| Platform              | ADF                                                                                                                                                                                            |
| Asset type            | Pipeline                                                                                                                                                                                       |
| Native path           | `/subscriptions/bee9b611-da99-4cfc-9fb7-50f1359e5ca2/resourceGroups/RG-InboundDataServices-Prod/providers/Microsoft.DataFactory/factories/ADF-InboundDataETL-Prod/pipelines/Acertus_Delivery2` |
...
| Primary target/output | Acertus_Delivered_GetFiles3, Acertus_Delivered_Staging3, Acertus_Delivered_VendorData3                                                                                                         |
...
1. Check the latest Acertus_Delivery2 parent run and identify the first failed child activity.
...
4. Confirm target datasets or child pipelines completed: Acertus_Delivered_GetFiles3, Acertus_Delivered_Staging3, Acertus_Delivered_VendorData3.
...
| Child pipelines   | Acertus_Delivered_GetFiles3, Acertus_Delivered_Staging3, Acertus_Delivered_VendorData3 |
...
| ---------------------------- | --------------- | ------------------------ | ------------------------ |
| Acertus_Delivered_GetFiles   | ExecutePipeline | not surfaced in metadata | not surfaced in metadata |
| Acertus_Delivered_Staging    | ExecutePipeline | not surfaced in metadata | not surfaced in metadata |
| Acertus_Delivered_VendorData | ExecutePipeline | not surfaced in metadata | not surfaced in metadata |
