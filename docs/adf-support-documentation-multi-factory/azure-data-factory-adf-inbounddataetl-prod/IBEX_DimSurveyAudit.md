...
Generated: 2026-06-29T10:58:59.081Z
...
IBEX_DimSurveyAudit is an ADF data movement in adf-inbounddataetl-prod. If IBEX_DimSurveyAudit fails or becomes stale, dependent ADF loads, files, datasets, or downstream reporting may be incomplete until the failed run is diagnosed and rerun through the approved parent path. Start troubleshooting by checking the latest ADF run for IBEX_DimSurveyAudit and confirm source and target datasets are available.
...
| Platform              | ADF                                                                                                                                                                                              |
| Asset type            | Pipeline                                                                                                                                                                                         |
| Native path           | `/subscriptions/bee9b611-da99-4cfc-9fb7-50f1359e5ca2/resourceGroups/RG-InboundDataServices-Prod/providers/Microsoft.DataFactory/factories/ADF-InboundDataETL-Prod/pipelines/IBEX_DimSurveyAudit` |
| Support role          | data movement                                                                                                                                                                                    |
| Business process      | adf-inbounddataetl-prod pipeline execution                                                                                                                                                       |
| Primary source        | SqlIBEXSurveyResponseSource                                                                                                                                                                      |
| Primary target/output | SqlIBEXSurveyResponseAuditStage                                                                                                                                                                  |
...
1. Check the latest ADF run for IBEX_DimSurveyAudit and confirm source and target datasets are available.
2. Confirm parameters are supplied by the parent, trigger, or documented default path: not surfaced in metadata.
3. Confirm source datasets are available: SqlIBEXSurveyResponseSource.
4. Confirm target datasets or child pipelines completed: SqlIBEXSurveyResponseAuditStage.
...
| Source datasets   | SqlIBEXSurveyResponseSource                                                          |
| Target datasets   | SqlIBEXSurveyResponseAuditStage                                                      |
| Stored procedures | [dbo].[uspLoadIBEXSurveyResponseAudit], [dbo].[uspLoadIBEXSurveyResponseAuditDetail] |
...
| SRC to STG                                | Copy                     | SqlIBEXSurveyResponseSource | SqlIBEXSurveyResponseAuditStage |
| EXEC uspLoadIBEXSurveyResponseAudit       | SqlServerStoredProcedure | not surfaced in metadata    | not surfaced in metadata        |
| EXEC uspLoadIBEXSurveyResponseAuditDetail | SqlServerStoredProcedure | not surfaced in metadata    | not surfaced in metadata        |
