# Acertus_Data_Transfer

Generated: 2026-06-29T10:58:59.019Z
...
Acertus_Data_Transfer is an ADF orchestrator in adf-inbounddataetl-prod. If Acertus_Data_Transfer fails or becomes stale, dependent ADF loads, files, datasets, or downstream reporting may be incomplete until the failed run is diagnosed and rerun through the approved parent path. Start troubleshooting by checking the latest Acertus_Data_Transfer parent run and identify the first failed child activity.
...
| Platform              | ADF                                                                                                                                                                                                |
| Asset type            | Pipeline                                                                                                                                                                                           |
| Native path           | `/subscriptions/bee9b611-da99-4cfc-9fb7-50f1359e5ca2/resourceGroups/RG-InboundDataServices-Prod/providers/Microsoft.DataFactory/factories/ADF-InboundDataETL-Prod/pipelines/Acertus_Data_Transfer` |
...
| Primary target/output | Acertus_Delivery, Acertus_Orders, Acertus_EnRoute                                                                                                                                                  |
| Schedule or trigger   | Acertus Trigger                                                                                                                                                                                    |
...
1. Check the latest Acertus_Data_Transfer parent run and identify the first failed child activity.
...
4. Confirm target datasets or child pipelines completed: Acertus_Delivery, Acertus_Orders, Acertus_EnRoute.
...
| Child pipelines   | Acertus_Delivery, Acertus_Orders, Acertus_EnRoute |
...
| ---------------- | --------------- | ------------------------ | ------------------------ |
| Acertus Delivery | ExecutePipeline | not surfaced in metadata | not surfaced in metadata |
| Acertus Orders   | ExecutePipeline | not surfaced in metadata | not surfaced in metadata |
| Acertus EnRoute  | ExecutePipeline | not surfaced in metadata | not surfaced in metadata |
