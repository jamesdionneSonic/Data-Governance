# pl_eleadactivity2adls

Generated: 2026-06-29T10:58:59.136Z
...
pl_eleadactivity2adls is an ADF data movement in adf-inbounddataetl-prod. If pl_eleadactivity2adls fails or becomes stale, dependent ADF loads, files, datasets, or downstream reporting may be incomplete until the failed run is diagnosed and rerun through the approved parent path. Start troubleshooting by checking the latest ADF run for pl_eleadactivity2adls and confirm source and target datasets are available.
...
| Platform              | ADF                                                                                                                                                                                                |
| Asset type            | Pipeline                                                                                                                                                                                           |
| Native path           | `/subscriptions/bee9b611-da99-4cfc-9fb7-50f1359e5ca2/resourceGroups/RG-InboundDataServices-Prod/providers/Microsoft.DataFactory/factories/ADF-InboundDataETL-Prod/pipelines/pl_eleadactivity2adls` |
| Support role          | data movement                                                                                                                                                                                      |
| Business process      | adf-inbounddataetl-prod pipeline execution                                                                                                                                                         |
| Primary source        | ds_pl_eleadactivity2adls                                                                                                                                                                           |
...
1. Check the latest ADF run for pl_eleadactivity2adls and confirm source and target datasets are available.
2. Confirm parameters are supplied by the parent, trigger, or documented default path: not surfaced in metadata.
3. Confirm source datasets are available: ds_pl_eleadactivity2adls.
...
| Source datasets   | ds_pl_eleadactivity2adls |
...
| ------------------------ | ---- | ------------------------ | ---------- |
| cp_pl_eleadactivity2adls | Copy | ds_pl_eleadactivity2adls | ds_parquet |
