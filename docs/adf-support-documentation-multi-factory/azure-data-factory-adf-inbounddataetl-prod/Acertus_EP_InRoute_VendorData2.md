# Acertus_EP_InRoute_VendorData2

Generated: 2026-06-29T10:58:59.043Z
...
Acertus_EP_InRoute_VendorData2 is an ADF child pipeline in adf-inbounddataetl-prod. If Acertus_EP_InRoute_VendorData2 fails or becomes stale, dependent ADF loads, files, datasets, or downstream reporting may be incomplete until the failed run is diagnosed and rerun through the approved parent path. Start troubleshooting by checking the parent pipeline that called Acertus_EP_InRoute_VendorData2; do not start the child with blank operational parameters.
...
| Platform              | ADF                                                                                                                                                                                                         |
| Asset type            | Pipeline                                                                                                                                                                                                    |
| Native path           | `/subscriptions/bee9b611-da99-4cfc-9fb7-50f1359e5ca2/resourceGroups/RG-InboundDataServices-Prod/providers/Microsoft.DataFactory/factories/ADF-InboundDataETL-Prod/pipelines/Acertus_EP_InRoute_VendorData2` |
| Support role          | child pipeline                                                                                                                                                                                              |
| Business process      | adf-inbounddataetl-prod pipeline execution                                                                                                                                                                  |
| Primary source        | ds_SQL_Acertus_Orders_Staging5                                                                                                                                                                              |
| Primary target/output | ds_SQL_Acertus_VendorData_InRoute2                                                                                                                                                                          |
...
1. Check the parent pipeline that called Acertus_EP_InRoute_VendorData2; do not start the child with blank operational parameters.
2. Confirm parameters are supplied by the parent, trigger, or documented default path: not surfaced in metadata.
3. Confirm source datasets are available: ds_SQL_Acertus_Orders_Staging5.
4. Confirm target datasets or child pipelines completed: ds_SQL_Acertus_VendorData_InRoute2.
...
| ----------------- | ---------------------------------- |
| Parent pipelines  | Acertus_EnRoute1                   |
| Child pipelines   | none surfaced                      |
| Source datasets   | ds_SQL_Acertus_Orders_Staging5     |
| Target datasets   | ds_SQL_Acertus_VendorData_InRoute2 |
...
| ------------------------------------ | ------- | ------------------------------ | ---------------------------------- |
| Copy data from Staging to VendorData | Copy    | ds_SQL_Acertus_Orders_Staging5 | ds_SQL_Acertus_VendorData_InRoute2 |
