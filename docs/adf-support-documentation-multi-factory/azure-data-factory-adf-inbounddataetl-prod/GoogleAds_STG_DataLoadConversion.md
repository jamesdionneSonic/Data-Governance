# GoogleAds_STG_DataLoadConversion

Generated: 2026-06-29T10:58:59.077Z
...
GoogleAds_STG_DataLoadConversion is an ADF child pipeline in adf-inbounddataetl-prod. If GoogleAds_STG_DataLoadConversion fails or becomes stale, dependent ADF loads, files, datasets, or downstream reporting may be incomplete until the failed run is diagnosed and rerun through the approved parent path. Start troubleshooting by checking the parent pipeline that called GoogleAds_STG_DataLoadConversion; do not start the child with blank operational parameters.
...
| Platform              | ADF                                                                                                                                                                                                           |
| Asset type            | Pipeline                                                                                                                                                                                                      |
| Native path           | `/subscriptions/bee9b611-da99-4cfc-9fb7-50f1359e5ca2/resourceGroups/RG-InboundDataServices-Prod/providers/Microsoft.DataFactory/factories/ADF-InboundDataETL-Prod/pipelines/GoogleAds_STG_DataLoadConversion` |
...
1. Check the parent pipeline that called GoogleAds_STG_DataLoadConversion; do not start the child with blank operational parameters.
...
| ----------------- | --------------------------------------- |
| Parent pipelines  | PL_GoogleAds_Conversion_IncrementalLoad |
