# trGoogleAdsDataLoadConversion

## Plain-English Summary

trGoogleAdsDataLoadConversion is an ADF trigger in adf-inbounddataetl-prod. It targets `PL_GoogleAds_Conversion_Master`. If trGoogleAdsDataLoadConversion fails or becomes stale, dependent ADF loads, files, datasets, or downstream reporting may be incomplete until the failed run is diagnosed and rerun through the approved parent path. Start troubleshooting by checking trigger state, schedule, and the latest target pipeline run.
...
| Platform              | ADF                                                                                                                                                                                                       |
| Asset type            | Trigger                                                                                                                                                                                                   |
| Native path           | `/subscriptions/bee9b611-da99-4cfc-9fb7-50f1359e5ca2/resourceGroups/RG-InboundDataServices-Prod/providers/Microsoft.DataFactory/factories/ADF-InboundDataETL-Prod/triggers/trGoogleAdsDataLoadConversion` |
...
| Primary target/output | PL_GoogleAds_Conversion_Master                                                                                                                                                                            |
...
| ---------------- | ------------------------------ |
| Target pipelines | PL_GoogleAds_Conversion_Master |
