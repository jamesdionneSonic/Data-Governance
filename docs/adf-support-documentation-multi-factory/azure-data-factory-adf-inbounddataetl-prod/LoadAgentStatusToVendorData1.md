# LoadAgentStatusToVendorData1

Generated: 2026-06-29T10:58:59.098Z
...
| Platform              | ADF                                                                                                                                                                                                       |
| Asset type            | Pipeline                                                                                                                                                                                                  |
| Native path           | `/subscriptions/bee9b611-da99-4cfc-9fb7-50f1359e5ca2/resourceGroups/RG-InboundDataServices-Prod/providers/Microsoft.DataFactory/factories/ADF-InboundDataETL-Prod/pipelines/LoadAgentStatusToVendorData1` |
| Support role          | child pipeline                                                                                                                                                                                            |
| Business process      | adf-inbounddataetl-prod pipeline execution                                                                                                                                                                |
| Primary source        | Verint_Staging_AgentStatus_ds2                                                                                                                                                                            |
| Primary target/output | Verint_AgentStatus_VendorData_ds1                                                                                                                                                                         |
...
1. Check the parent pipeline that called LoadAgentStatusToVendorData1; do not start the child with blank operational parameters.
2. Confirm parameters are supplied by the parent, trigger, or documented default path: not surfaced in metadata.
3. Confirm source datasets are available: Verint_Staging_AgentStatus_ds2.
4. Confirm target datasets or child pipelines completed: Verint_AgentStatus_VendorData_ds1.
...
| Source datasets   | Verint_Staging_AgentStatus_ds2    |
| Target datasets   | Verint_AgentStatus_VendorData_ds1 |
...
| -------------------------------- | ---- | ------------------------------ | --------------------------------- |
| Copy Agent Status to Vendor Data | Copy | Verint_Staging_AgentStatus_ds2 | Verint_AgentStatus_VendorData_ds1 |
