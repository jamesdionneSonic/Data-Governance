# Acertus_Orders_VendorData

Generated: 2026-06-29T10:58:59.049Z
...
Acertus_Orders_VendorData is an ADF data movement in adf-inbounddataetl-prod. If Acertus_Orders_VendorData fails or becomes stale, dependent ADF loads, files, datasets, or downstream reporting may be incomplete until the failed run is diagnosed and rerun through the approved parent path. Start troubleshooting by checking the latest ADF run for Acertus_Orders_VendorData and confirm source and target datasets are available.
...
| Platform              | ADF                                                                                                                                                                                                    |
| Asset type            | Pipeline                                                                                                                                                                                               |
| Native path           | `/subscriptions/bee9b611-da99-4cfc-9fb7-50f1359e5ca2/resourceGroups/RG-InboundDataServices-Prod/providers/Microsoft.DataFactory/factories/ADF-InboundDataETL-Prod/pipelines/Acertus_Orders_VendorData` |
| Support role          | data movement                                                                                                                                                                                          |
| Business process      | adf-inbounddataetl-prod pipeline execution                                                                                                                                                             |
| Primary source        | ds_SQL_Acertus_Orders_Staging2                                                                                                                                                                         |
| Primary target/output | ds_SQL_Acertus_Orders_VendorData                                                                                                                                                                       |
...
1. Check the latest ADF run for Acertus_Orders_VendorData and confirm source and target datasets are available.
2. Confirm parameters are supplied by the parent, trigger, or documented default path: not surfaced in metadata.
3. Confirm source datasets are available: ds_SQL_Acertus_Orders_Staging2.
4. Confirm target datasets or child pipelines completed: ds_SQL_Acertus_Orders_VendorData.
...
| Source datasets   | ds_SQL_Acertus_Orders_Staging2   |
| Target datasets   | ds_SQL_Acertus_Orders_VendorData |
...
| ------------------------------------ | ------- | ------------------------------ | -------------------------------- |
| Copy data from Staging to VendorData | Copy    | ds_SQL_Acertus_Orders_Staging2 | ds_SQL_Acertus_Orders_VendorData |
