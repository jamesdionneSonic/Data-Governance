# LoadAgentAdherenceToVendorData

Generated: 2026-06-29T10:58:59.093Z
...
LoadAgentAdherenceToVendorData is an ADF data movement in adf-inbounddataetl-prod. If LoadAgentAdherenceToVendorData fails or becomes stale, dependent ADF loads, files, datasets, or downstream reporting may be incomplete until the failed run is diagnosed and rerun through the approved parent path. Start troubleshooting by checking the latest ADF run for LoadAgentAdherenceToVendorData and confirm source and target datasets are available.
...
| Platform              | ADF                                                                                                                                                                                                         |
| Asset type            | Pipeline                                                                                                                                                                                                    |
| Native path           | `/subscriptions/bee9b611-da99-4cfc-9fb7-50f1359e5ca2/resourceGroups/RG-InboundDataServices-Prod/providers/Microsoft.DataFactory/factories/ADF-InboundDataETL-Prod/pipelines/LoadAgentAdherenceToVendorData` |
| Support role          | data movement                                                                                                                                                                                               |
| Business process      | adf-inbounddataetl-prod pipeline execution                                                                                                                                                                  |
| Primary source        | Verint_Staging_AgentAdherence_ds1                                                                                                                                                                           |
| Primary target/output | Verint_AgentAdherence_VendorData_ds                                                                                                                                                                         |
...
1. Check the latest ADF run for LoadAgentAdherenceToVendorData and confirm source and target datasets are available.
2. Confirm parameters are supplied by the parent, trigger, or documented default path: not surfaced in metadata.
3. Confirm source datasets are available: Verint_Staging_AgentAdherence_ds1.
4. Confirm target datasets or child pipelines completed: Verint_AgentAdherence_VendorData_ds.
...
| Source datasets   | Verint_Staging_AgentAdherence_ds1   |
| Target datasets   | Verint_AgentAdherence_VendorData_ds |
...
| ----------------------------------- | ---- | --------------------------------- | ----------------------------------- |
| Copy Agent Adherence to Vendor Data | Copy | Verint_Staging_AgentAdherence_ds1 | Verint_AgentAdherence_VendorData_ds |
