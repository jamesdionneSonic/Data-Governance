# IBEX_DimSurveyQuestion

Generated: 2026-06-29T10:58:59.084Z
...
IBEX_DimSurveyQuestion is an ADF data movement in adf-inbounddataetl-prod. If IBEX_DimSurveyQuestion fails or becomes stale, dependent ADF loads, files, datasets, or downstream reporting may be incomplete until the failed run is diagnosed and rerun through the approved parent path. Start troubleshooting by checking the latest ADF run for IBEX_DimSurveyQuestion and confirm source and target datasets are available.
...
| Platform              | ADF                                                                                                                                                                                                 |
| Asset type            | Pipeline                                                                                                                                                                                            |
| Native path           | `/subscriptions/bee9b611-da99-4cfc-9fb7-50f1359e5ca2/resourceGroups/RG-InboundDataServices-Prod/providers/Microsoft.DataFactory/factories/ADF-InboundDataETL-Prod/pipelines/IBEX_DimSurveyQuestion` |
| Support role          | data movement                                                                                                                                                                                       |
| Business process      | adf-inbounddataetl-prod pipeline execution                                                                                                                                                          |
| Primary source        | SqlIBEXQuestionSource, SqlIBEXSurveyResponseSource1                                                                                                                                                 |
| Primary target/output | SqlIBEXQuestionStage, SqlIBEXSurveyResponseStage                                                                                                                                                    |
...
1. Check the latest ADF run for IBEX_DimSurveyQuestion and confirm source and target datasets are available.
2. Confirm parameters are supplied by the parent, trigger, or documented default path: not surfaced in metadata.
3. Confirm source datasets are available: SqlIBEXQuestionSource, SqlIBEXSurveyResponseSource1.
4. Confirm target datasets or child pipelines completed: SqlIBEXQuestionStage, SqlIBEXSurveyResponseStage.
...
| Source datasets   | SqlIBEXQuestionSource, SqlIBEXSurveyResponseSource1 |
| Target datasets   | SqlIBEXQuestionStage, SqlIBEXSurveyResponseStage    |
...
| SRC to STG IBEXQuestions       | Copy                     | SqlIBEXQuestionSource        | SqlIBEXQuestionStage       |
| SRC to STG IBEXSurveyResponse  | Copy                     | SqlIBEXSurveyResponseSource1 | SqlIBEXSurveyResponseStage |
