...
Generated: 2026-06-29T10:58:59.091Z
...
| Platform              | ADF                                                                                                                                                                                            |
| Asset type            | Pipeline                                                                                                                                                                                       |
| Native path           | `/subscriptions/bee9b611-da99-4cfc-9fb7-50f1359e5ca2/resourceGroups/RG-InboundDataServices-Prod/providers/Microsoft.DataFactory/factories/ADF-InboundDataETL-Prod/pipelines/IBEX_SurveyMaster` |
...
| Primary target/output | IBEX_DimSurveyAudit1, IBEX_DimSurveyQuestion1, IBEX_FactSurveyAuditDetail1                                                                                                                     |
| Schedule or trigger   | IBEXMaster                                                                                                                                                                                     |
...
1. Check the latest IBEX_SurveyMaster parent run and identify the first failed child activity.
...
4. Confirm target datasets or child pipelines completed: IBEX_DimSurveyAudit1, IBEX_DimSurveyQuestion1, IBEX_FactSurveyAuditDetail1.
...
| Child pipelines   | IBEX_DimSurveyAudit1, IBEX_DimSurveyQuestion1, IBEX_FactSurveyAuditDetail1 |
...
| ---------------------------------- | --------------- | ------------------------ | ------------------------ |
| Execute IBEX_DimSurveyAudit        | ExecutePipeline | not surfaced in metadata | not surfaced in metadata |
| Execute IBEX_DimSurveyQuestion     | ExecutePipeline | not surfaced in metadata | not surfaced in metadata |
| Execute IBEX_FactSurveyAuditDetail | ExecutePipeline | not surfaced in metadata | not surfaced in metadata |
