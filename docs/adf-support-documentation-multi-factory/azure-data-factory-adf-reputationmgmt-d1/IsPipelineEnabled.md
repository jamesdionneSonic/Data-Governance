...
Generated: 2026-06-29T10:58:57.786Z
...
IsPipelineEnabled is an ADF standalone or utility pipeline in adf-reputationmgmt-d1. If IsPipelineEnabled fails or becomes stale, dependent ADF loads, files, datasets, or downstream reporting may be incomplete until the failed run is diagnosed and rerun through the approved parent path. Start troubleshooting by checking the latest ADF run for IsPipelineEnabled and confirm source and target datasets are available.
...
| Platform              | ADF                                                                                                                                                                                                                        |
| Asset type            | Pipeline                                                                                                                                                                                                                   |
| Native path           | `/subscriptions/bee9b611-da99-4cfc-9fb7-50f1359e5ca2/resourceGroups/rg-data-warehouse-prod/providers/Microsoft.DataFactory/factories/adf-ReputationMgmt-D1/pipelines/RepMgmt_IncrementalLoad/activities/IsPipelineEnabled` |
...
1. Check the latest ADF run for IsPipelineEnabled and confirm source and target datasets are available.
