...
| Platform              | ADF                                                                                                                                                                          |
| Asset type            | Trigger                                                                                                                                                                      |
| Native path           | `/subscriptions/bee9b611-da99-4cfc-9fb7-50f1359e5ca2/resourceGroups/rg-data-warehouse-prod/providers/Microsoft.DataFactory/factories/adf-XTime-D1/triggers/Tr_xTime_Monthly` |
| Support role          | Schedule / operational entry point                                                                                                                                           |
| Business process      | adf-xtime-d1 scheduling                                                                                                                                                      |
| Primary source        | ADF trigger schedule                                                                                                                                                         |
| Primary target/output | PL_Xtime_Master                                                                                                                                                              |
...
| ---------------- | --------------- |
| Target pipelines | PL_Xtime_Master |
