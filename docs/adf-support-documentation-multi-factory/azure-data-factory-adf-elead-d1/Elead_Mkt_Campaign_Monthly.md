...
| Platform              | ADF                                                                                                                                                                                    |
| Asset type            | Trigger                                                                                                                                                                                |
| Native path           | `/subscriptions/bee9b611-da99-4cfc-9fb7-50f1359e5ca2/resourceGroups/rg-data-warehouse-prod/providers/Microsoft.DataFactory/factories/adf-eLead-D1/triggers/Elead_Mkt_Campaign_Monthly` |
| Support role          | Schedule / operational entry point                                                                                                                                                     |
| Business process      | adf-elead-d1 scheduling                                                                                                                                                                |
| Primary source        | ADF trigger schedule                                                                                                                                                                   |
| Primary target/output | PL_Elead_Mkt_Campaign_Master                                                                                                                                                           |
...
| ---------------- | ---------------------------- |
| Target pipelines | PL_Elead_Mkt_Campaign_Master |
