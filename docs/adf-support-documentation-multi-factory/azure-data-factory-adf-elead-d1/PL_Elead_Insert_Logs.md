# PL_Elead_Insert_Logs

Generated: 2026-06-29T10:58:58.716Z
...
PL_Elead_Insert_Logs is an ADF standalone or utility pipeline in adf-elead-d1. If PL_Elead_Insert_Logs fails or becomes stale, dependent ADF loads, files, datasets, or downstream reporting may be incomplete until the failed run is diagnosed and rerun through the approved parent path. Start troubleshooting by checking the latest ADF run for PL_Elead_Insert_Logs and confirm source and target datasets are available.
...
| Platform              | ADF                                                                                                                                                                               |
| Asset type            | Pipeline                                                                                                                                                                          |
| Native path           | `/subscriptions/bee9b611-da99-4cfc-9fb7-50f1359e5ca2/resourceGroups/rg-data-warehouse-prod/providers/Microsoft.DataFactory/factories/adf-eLead-D1/pipelines/PL_Elead_Insert_Logs` |
...
1. Check the latest ADF run for PL_Elead_Insert_Logs and confirm source and target datasets are available.
2. Confirm parameters are supplied by the parent, trigger, or documented default path: ListOfFiles, SourceSystem, ExecutionConfig, ExecutionConfigUnit, ETL_Execution_ID, UserName.
