# Elead_Historical_Load

## Plain-English Summary

Elead_Historical_Load is an ADF trigger in adf-elead-d1. It targets `PL_Elead_Mkt_Campaign_Historical_Support`. If Elead_Historical_Load fails or becomes stale, dependent ADF loads, files, datasets, or downstream reporting may be incomplete until the failed run is diagnosed and rerun through the approved parent path. Start troubleshooting by checking trigger state, schedule, and the latest target pipeline run.
...
| Platform              | ADF                                                                                                                                                                               |
| Asset type            | Trigger                                                                                                                                                                           |
| Native path           | `/subscriptions/bee9b611-da99-4cfc-9fb7-50f1359e5ca2/resourceGroups/rg-data-warehouse-prod/providers/Microsoft.DataFactory/factories/adf-eLead-D1/triggers/Elead_Historical_Load` |
| Support role          | Schedule / operational entry point                                                                                                                                                |
| Business process      | adf-elead-d1 scheduling                                                                                                                                                           |
| Primary source        | ADF trigger schedule                                                                                                                                                              |
| Primary target/output | PL_Elead_Mkt_Campaign_Historical_Support                                                                                                                                          |
...
| ---------------- | ---------------------------------------- |
| Target pipelines | PL_Elead_Mkt_Campaign_Historical_Support |
