# PL_Elead_Mkt_Campaign_Master

Generated: 2026-06-29T10:58:58.726Z
...
PL_Elead_Mkt_Campaign_Master is an ADF standalone or utility pipeline in adf-elead-d1. If PL_Elead_Mkt_Campaign_Master fails or becomes stale, dependent ADF loads, files, datasets, or downstream reporting may be incomplete until the failed run is diagnosed and rerun through the approved parent path. Start troubleshooting by checking the latest ADF run for PL_Elead_Mkt_Campaign_Master and confirm source and target datasets are available.
...
| Platform              | ADF                                                                                                                                                                                       |
| Asset type            | Pipeline                                                                                                                                                                                  |
| Native path           | `/subscriptions/bee9b611-da99-4cfc-9fb7-50f1359e5ca2/resourceGroups/rg-data-warehouse-prod/providers/Microsoft.DataFactory/factories/adf-eLead-D1/pipelines/PL_Elead_Mkt_Campaign_Master` |
...
| Schedule or trigger   | Elead_Mkt_Campaign_Monthly                                                                                                                                                                |
...
1. Check the latest ADF run for PL_Elead_Mkt_Campaign_Master and confirm source and target datasets are available.
...
| GetErrorFileLists                     | Lookup                   | not surfaced in metadata | not surfaced in metadata |
| SendMailOnFailure                     | SqlServerStoredProcedure | not surfaced in metadata | not surfaced in metadata |
| SetUserNameForLS                      | SetVariable              | not surfaced in metadata | not surfaced in metadata |
| Get LastLoadDate                      | Lookup                   | not surfaced in metadata | not surfaced in metadata |
| CheckToRunChild                       | IfCondition              | not surfaced in metadata | not surfaced in metadata |
