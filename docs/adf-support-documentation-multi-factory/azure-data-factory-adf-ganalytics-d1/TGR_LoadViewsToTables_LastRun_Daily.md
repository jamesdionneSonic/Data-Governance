# TGR_LoadViewsToTables_LastRun_Daily

## Plain-English Summary

TGR_LoadViewsToTables_LastRun_Daily is an ADF trigger in adf-ganalytics-d1. It targets `PL_Load_AdvertisingQueries_Master`. If TGR_LoadViewsToTables_LastRun_Daily fails or becomes stale, dependent ADF loads, files, datasets, or downstream reporting may be incomplete until the failed run is diagnosed and rerun through the approved parent path. Start troubleshooting by checking trigger state, schedule, and the latest target pipeline run.
...
| Platform              | ADF                                                                                                                                                                                                  |
| Asset type            | Trigger                                                                                                                                                                                              |
| Native path           | `/subscriptions/bee9b611-da99-4cfc-9fb7-50f1359e5ca2/resourceGroups/rg-data-warehouse-prod/providers/Microsoft.DataFactory/factories/adf-GAnalytics-D1/triggers/TGR_LoadViewsToTables_LastRun_Daily` |
...
| Primary target/output | PL_Load_AdvertisingQueries_Master                                                                                                                                                                    |
...
| ---------------- | --------------------------------- |
| Target pipelines | PL_Load_AdvertisingQueries_Master |
