...
This pipeline supports the adf-dw-postgres-prod ADF process. Its available metadata shows 0 activity step(s), 0 child pipeline call(s), 0 source dataset reference(s), and 0 target dataset reference(s).
