...
Generated: 2026-06-29T10:58:58.322Z
...
PL_MCI_Acquisition is an ADF child pipeline in adf-mci-d1. If PL_MCI_Acquisition fails or becomes stale, dependent ADF loads, files, datasets, or downstream reporting may be incomplete until the failed run is diagnosed and rerun through the approved parent path. Start troubleshooting by checking the parent pipeline that called PL_MCI_Acquisition; do not start the child with blank operational parameters.
...
| Platform              | ADF                                                                                                                                                                           |
| Asset type            | Pipeline                                                                                                                                                                      |
| Native path           | `/subscriptions/bee9b611-da99-4cfc-9fb7-50f1359e5ca2/resourceGroups/rg-data-warehouse-prod/providers/Microsoft.DataFactory/factories/adf-MCI-D1/pipelines/PL_MCI_Acquisition` |
| Support role          | child pipeline                                                                                                                                                                |
| Business process      | adf-mci-d1 pipeline execution                                                                                                                                                 |
| Primary source        | DS_MCI_Acquisition                                                                                                                                                            |
| Primary target/output | DS_SFTP_MCIAquisition                                                                                                                                                         |
...
1. Check the parent pipeline that called PL_MCI_Acquisition; do not start the child with blank operational parameters.
...
3. Confirm source datasets are available: DS_MCI_Acquisition.
4. Confirm target datasets or child pipelines completed: DS_SFTP_MCIAquisition.
...
| ----------------- | ------------------------------------- |
| Parent pipelines  | PL_MCI_Acquisition_Incremental        |
| Child pipelines   | none surfaced                         |
| Source datasets   | DS_MCI_Acquisition                    |
| Target datasets   | DS_SFTP_MCIAquisition                 |
...
| ----------------------------------- | ------------------------ | ------------------------ | ------------------------ |
| SET MCIAcquisition Count            | SetVariable              | not surfaced in metadata | not surfaced in metadata |
...
| Load MCIAcquisitionFile_SQL To SFTP | Copy                     | DS_MCI_Acquisition       | DS_SFTP_MCIAquisition    |
