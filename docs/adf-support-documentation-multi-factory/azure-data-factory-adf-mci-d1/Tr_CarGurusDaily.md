...
| Platform              | ADF                                                                                                                                                                        |
| Asset type            | Trigger                                                                                                                                                                    |
| Native path           | `/subscriptions/bee9b611-da99-4cfc-9fb7-50f1359e5ca2/resourceGroups/rg-data-warehouse-prod/providers/Microsoft.DataFactory/factories/adf-MCI-D1/triggers/Tr_CarGurusDaily` |
| Support role          | Schedule / operational entry point                                                                                                                                         |
| Business process      | adf-mci-d1 scheduling                                                                                                                                                      |
| Primary source        | ADF trigger schedule                                                                                                                                                       |
| Primary target/output | PL_MCI_CarGurus_Master                                                                                                                                                     |
...
| ---------------- | ---------------------- |
| Target pipelines | PL_MCI_CarGurus_Master |
