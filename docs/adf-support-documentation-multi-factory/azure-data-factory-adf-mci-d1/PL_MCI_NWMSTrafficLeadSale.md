# PL_MCI_NWMSTrafficLeadSale

Generated: 2026-06-29T10:58:58.353Z
...
PL_MCI_NWMSTrafficLeadSale is an ADF child pipeline in adf-mci-d1. If PL_MCI_NWMSTrafficLeadSale fails or becomes stale, dependent ADF loads, files, datasets, or downstream reporting may be incomplete until the failed run is diagnosed and rerun through the approved parent path. Start troubleshooting by checking the parent pipeline that called PL_MCI_NWMSTrafficLeadSale; do not start the child with blank operational parameters.
...
| Platform              | ADF                                                                                                                                                                                   |
| Asset type            | Pipeline                                                                                                                                                                              |
| Native path           | `/subscriptions/bee9b611-da99-4cfc-9fb7-50f1359e5ca2/resourceGroups/rg-data-warehouse-prod/providers/Microsoft.DataFactory/factories/adf-MCI-D1/pipelines/PL_MCI_NWMSTrafficLeadSale` |
| Support role          | child pipeline                                                                                                                                                                        |
| Business process      | adf-mci-d1 pipeline execution                                                                                                                                                         |
| Primary source        | DS_SQL_EPLeadSale1                                                                                                                                                                    |
| Primary target/output | DS_SFTP_NWMSTrafficLeadSale, DS_ADL_NWMSTrafficLeadSale_csv                                                                                                                           |
...
1. Check the parent pipeline that called PL_MCI_NWMSTrafficLeadSale; do not start the child with blank operational parameters.
...
3. Confirm source datasets are available: DS_SQL_EPLeadSale1.
4. Confirm target datasets or child pipelines completed: DS_SFTP_NWMSTrafficLeadSale, DS_ADL_NWMSTrafficLeadSale_csv.
...
| ----------------- | ----------------------------------------------------------- |
| Parent pipelines  | PL_MCI_NWMSTrafficLeadSale_Incremental                      |
| Child pipelines   | none surfaced                                               |
| Source datasets   | DS_SQL_EPLeadSale1                                          |
| Target datasets   | DS_SFTP_NWMSTrafficLeadSale, DS_ADL_NWMSTrafficLeadSale_csv |
...
| ---------------------------------------- | ------------------------ | ------------------------ | ------------------------------ |
| SET NWMSLeadSale Count                   | SetVariable              | not surfaced in metadata | not surfaced in metadata       |
...
| Load NWMSTrafficLeadSaleFile_SQL To SFTP | Copy                     | DS_SQL_EPLeadSale1       | DS_SFTP_NWMSTrafficLeadSale    |
| Update Sync Table                        | Lookup                   | not surfaced in metadata | not surfaced in metadata       |
| Load NWMSTrafficLeadSaleFile_SQL To ADLS | Copy                     | DS_SQL_EPLeadSale1       | DS_ADL_NWMSTrafficLeadSale_csv |
