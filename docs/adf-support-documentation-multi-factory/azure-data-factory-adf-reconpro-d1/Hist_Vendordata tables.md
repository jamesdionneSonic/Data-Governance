# Hist_Vendordata tables

Generated: 2026-06-29T10:58:58.152Z
...
| Platform              | ADF                                                                                                                                                                                    |
| Asset type            | Pipeline                                                                                                                                                                               |
| Native path           | `/subscriptions/bee9b611-da99-4cfc-9fb7-50f1359e5ca2/resourceGroups/rg-data-warehouse-prod/providers/Microsoft.DataFactory/factories/adf-ReconPro-D1/pipelines/Hist_Vendordata tables` |
...
This pipeline supports the adf-reconpro-d1 ADF process. Its available metadata shows 8 activity step(s), 0 child pipeline call(s), 1 source dataset reference(s), and 1 target dataset reference(s).

## Support Checks

1. Check the latest ADF run for Hist_Vendordata tables and confirm source and target datasets are available.
...
| -------------------------- | ---- | ---------------------------- | ---------------------- |
| Hist_OrderPhases           | Copy | DS_SQL_SourceStageVendordata | DS_SQL_StageVendordata |
| Hist_OrderLogs             | Copy | DS_SQL_SourceStageVendordata | DS_SQL_StageVendordata |
| Hist_OrderServices         | Copy | DS_SQL_SourceStageVendordata | DS_SQL_StageVendordata |
| Hist_OrderVehicles         | Copy | DS_SQL_SourceStageVendordata | DS_SQL_StageVendordata |
| Hist_ServiceOrderQuestions | Copy | DS_SQL_SourceStageVendordata | DS_SQL_StageVendordata |
| Hist_ServiceReqServices    | Copy | DS_SQL_SourceStageVendordata | DS_SQL_StageVendordata |
| Hist_TechnicianDetails     | Copy | DS_SQL_SourceStageVendordata | DS_SQL_StageVendordata |
| Hist_InspectionVehicles    | Copy | DS_SQL_SourceStageVendordata | DS_SQL_StageVendordata |
