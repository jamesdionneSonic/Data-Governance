---
name: usp_FBCustomAudienceLostServiceCustomers
database: Sonic_DW
type: procedure
schema: dbo
owner: Data Team
...
```sql
CREATE   PROCEDURE [dbo].[usp_FBCustomAudienceLostServiceCustomers]
...
--select * from FBCustomAudience
	...
	SELECT S.AudienceID
		...
		,@MetaSourceSystemID
		,@ETLExecutionID
	FROM ETL_Staging.[dbo].[StgFBAudienceLostServiceCustomers] AS S;
END;
--END of SP
