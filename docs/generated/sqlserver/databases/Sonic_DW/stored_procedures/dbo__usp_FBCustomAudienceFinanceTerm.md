---
name: usp_FBCustomAudienceFinanceTerm
database: Sonic_DW
type: procedure
schema: dbo
owner: Data Team
...
Sample Call :
    EXEC [Sonic_DW].[dbo].[usp_FBCustomAudienceFinanceTerm]
...
CREATE   PROCEDURE [dbo].[usp_FBCustomAudienceFinanceTerm]
...
SELECT S.AudienceID,
          ...
          @MetaSourceSystemID,
          @ETLExecutionID
         FROM ETL_Staging.[dbo].[StgFBAudienceFinanceTerm] AS S;
     END;
    --END of SP
