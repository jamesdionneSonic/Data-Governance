---
name: usp_Fuel2_Insert_Dim_GLSchedule_degen_Step_6A
database: Sonic_DW
type: procedure
schema: dbo
owner: Data Team
...
BEGIN
	SET NOCOUNT ON;
		...
		------------------------------------------------------------------------------------------
			...
			USING ETL_Staging.wrk.GLSchedule_Step_6A AS S
				ON (
