---
name: usp_FacebookNonServiceCustomers
database: Sonic_DW
type: procedure
schema: dbo
owner: Data Team
...
CREATE   PROCEDURE [dbo].[usp_FacebookNonServiceCustomers]


/*********************************************************************************************************

Purpose : GetCustomers who purchased their vehicle at Sonic and have not serviced their vehicle at sonic location for more than 12/15 months to last 60 months of vehicle purchased.
EXEC [dbo].[usp_FacebookNonServiceCustomers]
...
Description :  Removed Ford brand to have it under 12 months
...
AS
     BEGIN
         ...
         WITH NonServiceCustomers
			...
			,DC.DMSCstAddressCity as City,
                     ...
                     'NonServiceCustomers' AS AudienceType
 ...
 -- exclude recent customers [we don't want to email Customers who recently serviced their vehicle]
             ...
             FROM NonServiceCustomers AS LC
              ...
              WHERE ET.RelationshipType = 'FBAudienceNonServiceCustomers'
