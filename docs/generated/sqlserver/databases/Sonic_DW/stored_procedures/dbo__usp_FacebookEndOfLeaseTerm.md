---
name: usp_FacebookEndOfLeaseTerm
database: Sonic_DW
type: procedure
schema: dbo
owner: Data Team
...
Jay				2022-02-23	   Added GMC, Cadillac, Chevrolet and Ford brands for 9 and 12 months respectively
Keerthi k       2022-04029     Getting 3 new columns(PhoneNumber, ZipCode, City) With the existing columns
*/
CREATE    PROCEDURE [dbo].[usp_FacebookEndOfLeaseTerm] @EOLMonth INT
	,@EOLRange INT
AS
BEGIN
	...
	WHERE (
			...
			AND ET.RelationshipType = 'FBAudienceEndofLease'
