---
name: usp_FBCustomAudienceEquityCustomers
database: Sonic_DW
type: procedure
schema: dbo
owner: Data Team
...
```sql
CREATE   PROCEDURE [dbo].[usp_FBCustomAudienceEquityCustomers]
...
AS
	...
	SELECT S.AudienceID
		...
		,@MetaSourceSystemID
		,@ETLExecutionID
	FROM ETL_Staging.[dbo].[StgFBAudienceEquityCustomers] AS S;
END;
--END of SP
