---
name: usp_LoadFactTrafficSummarySubSource_MTD
database: Sonic_DW
type: procedure
schema: dbo
owner: Data Team
...
-- =================================================
CREATE   Procedure [dbo].[usp_LoadFactTrafficSummarySubSource_MTD]
--(
...
SELECT DISTINCT
  ...
  FROM [ETL_Staging].[dbo].[StageTrafficDailySourceSubSourceAgg_MTD] agg
