---
name: usp_Fuel2_Insert_Dim_GLSchedule_degen_Raj
database: Sonic_DW
type: procedure
schema: dbo
owner: Data Team
...
*************************************************************************/
CREATE PROCEDURE [dbo].[usp_Fuel2_Insert_Dim_GLSchedule_degen_Raj]
...
THEN
	UPDATE SET
		...
		--,[t].[Meta_NaturalKey]		=	[s].[Meta_NaturalKey]
		,[t].[ETLExecution_ID]		=	[s].[ETLExecution_ID]
		--,[t].[Meta_RowEffectiveDate]	=	[s].Meta_RowEffectiveDate
		--,[t].[Meta_RowLastChangedDate] =	GETDATE()
		--,[t].[Meta_RowIsCurrent]		=	[s].[Meta_RowIsCurrent]
