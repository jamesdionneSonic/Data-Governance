---
name: vwCallidusWealthAssociate_0428
database: Sonic_DW
type: view
schema: dbo
owner: Data Team
...
CREATE view [dbo].[vwCallidusWealthAssociate_0428] as 
...
,
RCON as  --Regional Controller substitution.  This should be used for controller supervisorID (someho
```
