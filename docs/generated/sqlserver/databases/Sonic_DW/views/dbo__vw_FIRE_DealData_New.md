...
CREATE VIEW [dbo].[vw_FIRE_DealData_New]
AS
...
WITH    FFGU
          AS ( SELECT   f.StockNo
               ...
               WHERE   AccountingDateKey >= CAST(REPLACE(convert(varchar(10),dateadd(mm,-1,dateadd(dd,(DATEPART(dd,getdate())-1) * -1,getdate())),120),'-','') AS INT)
						...
						AND a.FIAccountClassification = 'New'-------------------------------- added by LD/Raj 01-28-19 replaces below case statment
        ...
        cte_FIREDeals
          AS ( SELECT   f.StockNo
					   ...
					   ,a.FIAccountClassification -------------------------------- added by LD/Raj 01-28-19 replaces below case statment
                       ...
                       ,f.AccountingDateKey
                       ,f.ContractDateKey
					   ,es1.AsoNameFirst + ' ' + es1.ASONameLast as SalesPerson1Name
					   ,esm.AsoNameFirst + ' ' + esm.ASONameLast as SalesManagerName
...
---------additional column added - Raj 06/30/2017--------------
           ,SUM(CASE WHEN FIAccountType = 'S'
               ...
               FROM     [Sonic_DW].[dbo].[factFIRE] (NOLOCK) f
						...
						LEFT JOIN Dim_DMSEmployee es1 ON es1.AssociateKey = f.SalesPerson1Key
						LEFT JOIN Dim_DMSEmployee esm ON esm.AssociateKey = f.SalesMgrKey
			  ...
			  -- f.AccountingDateKey >= '20170501'---commented by Raj 07/14/2017
               ...
               GROUP BY f.StockNo
                       ...
                       ,f.AccountingDateKey
                       ,f.ContractDateKey
					   ,es1.AsoNameFirst + ' ' + es1.ASONameLast
					   ,esm.AsoNameFirst + ' ' + esm.ASONameLast
