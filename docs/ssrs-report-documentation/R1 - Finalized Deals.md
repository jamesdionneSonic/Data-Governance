...
| Platform              | SSRS                                                                                                                                                                              |
| Asset type            | Report                                                                                                                                                                            |
| Native path           | `/RTC/R1 - Finalized Deals`                                                                                                                                                       |
...
1. Dataset `DataSet1` (Text): SELECT oo.Name ,o.Name 'Dealership' ,vi.Stock_No 'Stock #' ,CASE WHEN LEFT(vi.stock_no,1) != 'S' THEN app.Appraised_By ELSE NULL END 'Appraiser' ,v.Year ,v.Make ,v.Model ,vi.Trim ,vi.Age ,CASE WHEN vi.Age < 21 THEN '
...
```sql
SELECT     oo.Name    ,o.Name  'Dealership'    ,vi.Stock_No 'Stock #'    ,CASE WHEN LEFT(vi.stock_no,1) != 'S' THEN app.Appraised_By    ELSE NULL     END 'Appraiser'    ,v.Year    ,v.Make    ,v.Model    ,vi.Trim    ,vi.Age     ,CASE WHEN vi.Age < 21 THEN '
```
