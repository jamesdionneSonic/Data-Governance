# New Inventory - Playbook - All_exp_Playbook_strpd

Generated: 2026-06-15  
SSRS path: `/BI - New Vehicles/Archive/New Inventory - Playbook - All_exp_Playbook_strpd`  
...
| Field               | Value                                                                          |
| ------------------- | ------------------------------------------------------------------------------ |
| Report name         | `New Inventory - Playbook - All_exp_Playbook_strpd`                            |
| SSRS path           | `/BI - New Vehicles/Archive/New Inventory - Playbook - All_exp_Playbook_strpd` |
| Status signal       | Review candidate: no executions in last 6 months                               |
| Created             | 2019-03-11 13:32:27                                                            |
| Modified            | 2025-12-20 10:58:17                                                            |
...
1. Confirm the user is running the correct SSRS path: `/BI - New Vehicles/Archive/New Inventory - Playbook - All_exp_Playbook_strpd`.
