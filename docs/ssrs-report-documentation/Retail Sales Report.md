...
SSRS path: `/BI - FPnA/Retail Sales Report`  
...
| Field               | Value                                            |
| ------------------- | ------------------------------------------------ |
| Report name         | `Retail Sales Report`                            |
| SSRS path           | `/BI - FPnA/Retail Sales Report`                 |
| Status signal       | Review candidate: no executions in last 6 months |
| Created             | 2014-08-15 13:39:31                              |
| Modified            | 2017-12-13 17:59:04                              |
...
1. Confirm the user is running the correct SSRS path: `/BI - FPnA/Retail Sales Report`.
