# New Inventory - Pricing - All_exp

Generated: 2026-06-15  
SSRS path: `/New Vehicles/New Inventory - Pricing - All_exp`  
...
| Field               | Value                                             |
| ------------------- | ------------------------------------------------- |
| Report name         | `New Inventory - Pricing - All_exp`               |
| SSRS path           | `/New Vehicles/New Inventory - Pricing - All_exp` |
| Status signal       | Review candidate: no executions in last 6 months  |
| Created             | 2015-04-23 16:37:23                               |
| Modified            | 2015-04-23 16:37:23                               |
...
| ----------------- | ------------------------------------------- | ---------------------------- | --------------- | ------- |
| `BI_WorkDB`       | `/New Vehicles/DataSource/COR_SQL_02_BIWDB` | `Not available from catalog` |                 |         |
...
1. Confirm the user is running the correct SSRS path: `/New Vehicles/New Inventory - Pricing - All_exp`.
