# Retail Sales Report_CleanGross_Hal_B1

Generated: 2026-06-19T08:45:51.070Z
SSRS path: `/BI - FPnA/Retail Sales Report_CleanGross_Hal_B1`
...
| Platform              | SSRS                                                                                                                                                                                                     |
| Asset type            | Report                                                                                                                                                                                                   |
| Native path           | `/BI - FPnA/Retail Sales Report_CleanGross_Hal_B1`                                                                                                                                                       |
...
| Runtime/usage signal  | 128 executions by 1 users; last used 2026-06-18 10:00:10                                                                                                                                                 |
| Status signal         | Active                                                                                                                                                                                                   |
| Evidence              | `tmp/ssrs-all-report-discovery.out`, `tmp/ssrs-all-datasets.out`                                                                                                                                         |
| Report name           | `Retail Sales Report_CleanGross_Hal_B1`                                                                                                                                                                  |
| Created               | 2015-01-07 17:44:10                                                                                                                                                                                      |
| Modified              | 2017-12-13 17:59:07                                                                                                                                                                                      |
...
1. Confirm the user is running the correct SSRS path: `/BI - FPnA/Retail Sales Report_CleanGross_Hal_B1`.
