# New Inventory - Count By Make Model Dealership

Generated: 2026-06-15  
SSRS path: `/New Inventory - Count By Make Model Dealership`  
...
| Field               | Value                                             |
| ------------------- | ------------------------------------------------- |
| Report name         | `New Inventory - Count By Make Model Dealership`  |
| SSRS path           | `/New Inventory - Count By Make Model Dealership` |
| Status signal       | Active                                            |
| Created             | 2025-11-14 14:27:13                               |
| Modified            | 2025-11-14 14:29:44                               |
| Modified by         | Jonathan.Henin                                    |
| Last 6 months usage | 1 executions by 1 users                           |
| Last execution      | 2026-06-10 14:13:37                               |
| Subscriptions       | 0                                                 |
...
1. Confirm the user is running the correct SSRS path: `/New Inventory - Count By Make Model Dealership`.
