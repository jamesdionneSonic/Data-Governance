# Copy of Retail Sales Report_CleanGross_Hal

Generated: 2026-06-15  
SSRS path: `/BI - FPnA/Copy of Retail Sales Report_CleanGross_Hal`  
...
| Field               | Value                                                   |
| ------------------- | ------------------------------------------------------- |
| Report name         | `Copy of Retail Sales Report_CleanGross_Hal`            |
| SSRS path           | `/BI - FPnA/Copy of Retail Sales Report_CleanGross_Hal` |
| Status signal       | Review candidate: no executions in last 6 months        |
| Created             | 2017-12-13 17:58:58                                     |
| Modified            | 2017-12-13 17:58:58                                     |
...
2. Dataset `Retail_Sales_MTD_lastyear` (Text): /_------------------------------------------------------------------------------------------------------------------ view to pull vehicle information --GOOD ------------------------------------------------------------------------------------------------------------------_/ WITH VSC AS (SELECT DISTINCT c.related_acctg_c...
...
1. Confirm the user is running the correct SSRS path: `/BI - FPnA/Copy of Retail Sales Report_CleanGross_Hal`.
