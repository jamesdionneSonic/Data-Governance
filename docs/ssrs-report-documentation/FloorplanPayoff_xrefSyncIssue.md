# FloorplanPayoff_xrefSyncIssue

Generated: 2026-06-15  
SSRS path: `/BI - Shared Services/FloorplanPayoff_xrefSyncIssue`  
...
| Field               | Value                                                 |
| ------------------- | ----------------------------------------------------- |
| Report name         | `FloorplanPayoff_xrefSyncIssue`                       |
| SSRS path           | `/BI - Shared Services/FloorplanPayoff_xrefSyncIssue` |
| Status signal       | Review candidate: no executions in last 6 months      |
| Created             | 2017-06-09 14:31:33                                   |
...
| ----------------- | -------------------------------------- | ---------------------------- | --------------- | ------- |
| `DMS`             | `/BI - Shared Services/DataSource/DMS` | `Not available from catalog` |                 |         |
...
1. Confirm the user is running the correct SSRS path: `/BI - Shared Services/FloorplanPayoff_xrefSyncIssue`.
