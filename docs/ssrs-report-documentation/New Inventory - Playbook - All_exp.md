# New Inventory - Playbook - All_exp

Generated: 2026-06-15  
SSRS path: `/RptTest/New Inventory - Playbook - All_exp`  
...
| Field               | Value                                            |
| ------------------- | ------------------------------------------------ |
| Report name         | `New Inventory - Playbook - All_exp`             |
| SSRS path           | `/RptTest/New Inventory - Playbook - All_exp`    |
| Status signal       | Review candidate: no executions in last 6 months |
| Created             | 2014-08-01 14:37:52                              |
| Modified            | 2014-08-01 14:37:52                              |
...
| ----------------- | ------------------------------ | ---------------------------- | --------------- | ------- |
| `BI_WorkDB`       | `/DataSource/COR_SQL_02_BIWDB` | `Not available from catalog` |                 |         |
...
1. Confirm the user is running the correct SSRS path: `/RptTest/New Inventory - Playbook - All_exp`.
