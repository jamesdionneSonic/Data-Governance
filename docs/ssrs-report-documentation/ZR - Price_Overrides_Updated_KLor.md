...
| Platform              | SSRS                                                                                                                                          |
| Asset type            | Report                                                                                                                                        |
| Native path           | `/RTC/ZR - Price_Overrides_Updated_KLor`                                                                                                      |
...
1. Dataset `DataSet1` (Text): CREATE TABLE #Priceovr (Dealership varchar(50),VIN varchar(17),Stock# varchar(50),PostDate DATETIME,Status varchar(50),Age numeric(4),Year numeric(4),Make varchar(50),Model varchar(50),Trim varchar(125),Mileage numeric(6), Color varchar(50),CPO varchar(2),
...
```sql
CREATE TABLE #Priceovr (Dealership varchar(50),VIN varchar(17),Stock# varchar(50),PostDate DATETIME,Status varchar(50),Age numeric(4),Year numeric(4),Make varchar(50),Model varchar(50),Trim varchar(125),Mileage numeric(6), Color varchar(50),CPO varchar(2),
```
