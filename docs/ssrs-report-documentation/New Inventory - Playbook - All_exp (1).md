# New Inventory - Playbook - All_exp (1)

Generated: 2026-06-15  
SSRS path: `/BI - New Vehicles/Archive/New Inventory - Playbook - All_exp (1)`  
...
| Field               | Value                                                               |
| ------------------- | ------------------------------------------------------------------- |
| Report name         | `New Inventory - Playbook - All_exp (1)`                            |
| SSRS path           | `/BI - New Vehicles/Archive/New Inventory - Playbook - All_exp (1)` |
| Status signal       | Review candidate: no executions in last 6 months                    |
| Created             | 2018-12-14 14:14:28                                                 |
| Modified            | 2025-12-20 10:58:31                                                 |
...
| ----------------- | ------------------------------------------------ | ---------------------------- | --------------- | ------- |
| `BI_WorkDB`       | `/BI - New Vehicles/DataSource/COR_SQL_02_BIWDB` | `Not available from catalog` |                 |         |
...
2. Dataset `NewInventory` (Text): with EntryDate as (select companyid,control,min(dateofoldestscheditem) DOOSI from dms.dbo.glschedule where currentmonth > DATEADD(dd,-550,getdate()) and right(accountnumber,4) in ('2320','2300','2340','2341','2342') group by companyid,control ) , companyidLkp as (SELECT distinct [CompanyID] ,[WebV_ID] FROM [BI_WorkDB]....
...
1. Confirm the user is running the correct SSRS path: `/BI - New Vehicles/Archive/New Inventory - Playbook - All_exp (1)`.
