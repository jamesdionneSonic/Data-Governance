...
| Platform              | SSRS                                                                                                                                          |
| Asset type            | Report                                                                                                                                        |
| Native path           | `/RTC/ZR - InValue_VS_TradeValue`                                                                                                             |
...
1. Dataset `DataSet1` (Text): SELECT --vi.Curr_Status_ID, --vi.Vehicle_ID, o.Name AS 'Dealership', v.VIN, vi.Stock_No, vi.Acquired_Type, vi.Acquired_Date, s.Status_Abbv 'Status', vp.Acquired_Value , sac.SAC_Recom_Apprsl_Value 'RTC_Recom Apprsl_Value', 'Difference' = vp.Acquired_Value -
...
```sql
SELECT --vi.Curr_Status_ID, --vi.Vehicle_ID, o.Name AS 'Dealership', v.VIN, vi.Stock_No, vi.Acquired_Type, vi.Acquired_Date, s.Status_Abbv 'Status', vp.Acquired_Value , sac.SAC_Recom_Apprsl_Value 'RTC_Recom Apprsl_Value', 'Difference' = vp.Acquired_Value -
```
