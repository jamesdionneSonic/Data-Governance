# New Inventory - Count By Make

Generated: 2026-06-15  
SSRS path: `/BI - New Vehicles/New Inventory - Count By Make`  
...
| Field               | Value                                              |
| ------------------- | -------------------------------------------------- |
| Report name         | `New Inventory - Count By Make`                    |
| SSRS path           | `/BI - New Vehicles/New Inventory - Count By Make` |
| Status signal       | Active                                             |
| Created             | 2016-03-24 14:54:04                                |
| Modified            | 2025-02-04 20:13:08                                |
| Modified by         | Jonathan.Henin                                     |
| Last 6 months usage | 360 executions by 2 users                          |
| Last execution      | 2026-06-15 08:00:01                                |
| Subscriptions       | 2                                                  |
...
1. Confirm the user is running the correct SSRS path: `/BI - New Vehicles/New Inventory - Count By Make`.
