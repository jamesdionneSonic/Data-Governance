# pl_mdp_dms_individual

Generated: 2026-06-19T08:45:26.971Z
...
pl_mdp_dms_individual is an ADF child pipeline in dms. Use this pipeline to move individual/person identity data used by downstream marketing and customer matching processes. If it fails, downstream marketing export or mapping data may be stale or incomplete. Start troubleshooting by checking whether the parent orchestrator passed operational IDs into pl_mdp_dms_individual; do not start this child with blank parameters.
...
| Platform              | ADF                                                                                                                                                                                         |
| Asset type            | Pipeline                                                                                                                                                                                    |
| Native path           | `/subscriptions/bee9b611-da99-4cfc-9fb7-50f1359e5ca2/resourceGroups/rg-data-warehouse-prod/providers/Microsoft.DataFactory/factories/adf-dw-marketing-prod/pipelines/pl_mdp_dms_individual` |
| Support role          | child pipeline                                                                                                                                                                              |
| Business process      | Use this pipeline to move individual/person identity data used by downstream marketing and customer matching processes.                                                                     |
...
Use this pipeline to move individual/person identity data used by downstream marketing and customer matching processes.

## Support Checks

1. Check whether the parent orchestrator passed operational IDs into pl_mdp_dms_individual; do not start this child with blank parameters.
...
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| Parent pipelines  | pl_Marketing_AWS_Export                                                                                                             |
