...
| ------------ | ---------- | ---------------------------------- | ---------: |
| contains     | svc_np_mdp | AWS Glue Data Catalog - svc_np_mdp |       0.95 |
| contains     | svc_np_mdp | Amazon S3 - svc_np_mdp             |       0.95 |
| contains     | svc_np_mdp | Amazon Athena - svc_np_mdp         |       0.95 |
