...
| ------------ | ---------- | ---------------------------------- | ---------: |
| contains     | svc_pp_mdp | Amazon Athena - svc_pp_mdp         |       0.95 |
| contains     | svc_pp_mdp | AWS Glue Data Catalog - svc_pp_mdp |       0.95 |
| contains     | svc_pp_mdp | Amazon S3 - svc_pp_mdp             |       0.95 |
