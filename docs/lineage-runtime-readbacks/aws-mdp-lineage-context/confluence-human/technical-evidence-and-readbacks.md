...
| Output                   | Local path                                                                                                              |
| ------------------------ | ----------------------------------------------------------------------------------------------------------------------- |
| Human page markdown      | C:/projects/Data Governence/docs/lineage-runtime-readbacks/aws-mdp-lineage-context/confluence-human                     |
| Rovo retrieval artifacts | C:/projects/Data Governence/docs/lineage-runtime-readbacks/aws-mdp-lineage-context/confluence-rovo                      |
| DevOps machine files     | C:/projects/Data Governence/docs/lineage-runtime-readbacks/aws-mdp-lineage-context/devops                               |
| Package manifest         | C:/projects/Data Governence/docs/lineage-runtime-readbacks/aws-mdp-lineage-context/mdp-aws-lineage-context-package.json |
